...
--  and SSIRXD0 are sampled at a falling edge of SSIBCK).
   ...
   subtype SSICR_Reserved_Field is R7FA4M1AB.UInt3;
   ...
   type SSICR_Register is record
      ...
      Reserved_2 : SSICR_Reserved_Field := 16#0#;
      --  Idle Mode Interrupt Output Enable
   ...
   for SSIFCR_Register use record
...
--  one.
   ...
   for SSIFSR_Register use record
      RDF            at 0 range 0 .. 0;
   ...
   for SSITDMR_Register use record
      OMOD       at 0 range 0 .. 1;
   ...
   for SSISCR_Register use record
      RDFS       at 0 range 0 .. 2;
   ...
   for SSIE0_Peripheral use record
