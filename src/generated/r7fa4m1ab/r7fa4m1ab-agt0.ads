...
package R7FA4M1AB.AGT0 is
   ...
   for AGTMR1_Register use record
      TMOD     at 0 range 0 .. 2;
   ...
   for AGTMR2_Register use record
      CKS      at 0 range 0 .. 2;
   ...
   subtype AGTIOC_TIOGT_Field is R7FA4M1AB.UInt2;
   ...
   type AGTIOC_Register is record
      ...
      --  Count control
      TIOGT      : AGTIOC_TIOGT_Field := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 8,
          Bit_Order => System.Low_Order_First;

   for AGTIOC_Register use record
   ...
   for AGTISR_Register use record
   ...
   for AGTCMSR_Register use record
...
--  output
   ...
   for AGTIOSEL_Register use record
      SEL        at 0 range 0 .. 1;
   ...
   for AGT0_Peripheral use record
   ...
   --  Asynchronous General purpose Timer 0
   AGT0_Periph : aliased AGT0_Peripheral
     with Import, Address => AGT0_Base;
