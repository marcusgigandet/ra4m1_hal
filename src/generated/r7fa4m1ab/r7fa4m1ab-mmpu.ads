...
package R7FA4M1AB.MMPU is
   ...
   type MMPUCTLA_ENABLE_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for MMPUCTLA_ENABLE_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type MMPUCTLA_OAD_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for MMPUCTLA_OAD_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type MMPUPTA_PROTECT_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for MMPUPTA_PROTECT_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type MMPUPTA_KEY_Field is
     ...
     Val_0xA5,
      ...
      others_k)
   with Size => 8;
   for MMPUPTA_KEY_Field use (Val_0xA5 => 165, others_k => 255);
   ...
   type MMPUACA0_ENABLE_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for MMPUACA0_ENABLE_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type MMPUACA0_RP_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for MMPUACA0_RP_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type MMPUACA0_WP_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for MMPUACA0_WP_Field use (Val_0 => 0, Val_1 => 1);
