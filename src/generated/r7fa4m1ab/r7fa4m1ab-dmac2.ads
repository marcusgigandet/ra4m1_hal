...
package R7FA4M1AB.DMAC2 is
   ...
   type DMTMD_SZ_Field is
     ...
     Val_00,
      ...
      Val_11)
   with Size => 2;
   for DMTMD_SZ_Field use (Val_00 => 0, Val_01 => 1, Val_10 => 2, Val_11 => 3);
   ...
   type DMTMD_MD_Field is
     ...
     Val_00,
      ...
      Val_11)
   with Size => 2;
   for DMTMD_MD_Field use (Val_00 => 0, Val_01 => 1, Val_10 => 2, Val_11 => 3);

   --  DMA Transfer Mode Register
   type DMTMD_Register is record
      --  Transfer Request Source Select
      DCTG       : DMTMD_DCTG_Field := R7FA4M1AB.DMAC2.Val_00;
      --  These bits are read as 000000. The write value should be 000000.
      Reserved   : DMTMD_Reserved_Field := 16#0#;
      --  Transfer Data Size Select
      SZ         : DMTMD_SZ_Field := R7FA4M1AB.DMAC2.Val_00;
      --  These bits are read as 00. The write value should be 00.
      Reserved_1 : DMTMD_Reserved_Field_1 := 16#0#;
      --  Repeat Area Select
      DTS        : DMTMD_DTS_Field := R7FA4M1AB.DMAC2.Val_00;
      --  Transfer Mode Select
      MD         : DMTMD_MD_Field := R7FA4M1AB.DMAC2.Val_00;
   end record
   with
     Volatile_Full_Access,
     Object_Size => 16,
   ...
   type DMINT_DARIE_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for DMINT_DARIE_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type DMINT_SARIE_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for DMINT_SARIE_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type DMINT_RPTIE_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for DMINT_RPTIE_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type DMINT_ESIE_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for DMINT_ESIE_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type DMINT_DTIE_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for DMINT_DTIE_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type DMINT_Register is record
      --  Destination Address Extended Repeat Area Overflow Interrupt Enable
      DARIE    : DMINT_DARIE_Field := R7FA4M1AB.DMAC2.Val_0;
      --  Source Address Extended Repeat Area Overflow Interrupt Enable
      SARIE    : DMINT_SARIE_Field := R7FA4M1AB.DMAC2.Val_0;
      --  Repeat Size End Interrupt Enable
      RPTIE    : DMINT_RPTIE_Field := R7FA4M1AB.DMAC2.Val_0;
      --  Transfer Escape End Interrupt Enable
      ESIE     : DMINT_ESIE_Field := R7FA4M1AB.DMAC2.Val_0;
      --  Transfer End Interrupt Enable
      DTIE     : DMINT_DTIE_Field := R7FA4M1AB.DMAC2.Val_0;
   ...
   subtype DMAMD_Reserved_Field is R7FA4M1AB.Bit;
   ...
   type DMAMD_DM_Field is
     ...
     Val_00,
      ...
      Val_11)
   with Size => 2;
   for DMAMD_DM_Field use (Val_00 => 0, Val_01 => 1, Val_10 => 2, Val_11 => 3);
   ...
   type DMAMD_SM_Field is
     ...
     Val_00,
      ...
      Val_11)
   with Size => 2;
   for DMAMD_SM_Field use (Val_00 => 0, Val_01 => 1, Val_10 => 2, Val_11 => 3);
   ...
   type DMAMD_Register is record
      ...
      --  Destination Address Update Mode
      DM         : DMAMD_DM_Field := R7FA4M1AB.DMAC2.Val_00;
      ...
      --  Source Address Update Mode
      SM         : DMAMD_SM_Field := R7FA4M1AB.DMAC2.Val_00;
   end record
   with
     Volatile_Full_Access,
     Object_Size => 16,
   ...
   type DMCNT_DTE_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for DMCNT_DTE_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type DMCNT_Register is record
      ...
      --  Transfer Enable
      DTE      : DMCNT_DTE_Field := R7FA4M1AB.DMAC2.Val_0;
   ...
   type DMREQ_SWREQ_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for DMREQ_SWREQ_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type DMREQ_CLRS_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for DMREQ_CLRS_Field use (Val_0 => 0, Val_1 => 1);

   --  DMA Software Start Register
   type DMREQ_Register is record
      --  *** This field is modified following a read operation ***. DMA
      --  Software Start
      SWREQ      : DMREQ_SWREQ_Field := R7FA4M1AB.DMAC2.Val_0;
      --  These bits are read as 000. The write value should be 000.
      Reserved   : DMREQ_Reserved_Field := 16#0#;
      --  DMA Software Start Bit Auto Clear Select
      CLRS       : DMREQ_CLRS_Field := R7FA4M1AB.DMAC2.Val_0;
      --  These bits are read as 000. The write value should be 000.
   ...
   type DMSTS_ESIF_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for DMSTS_ESIF_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type DMSTS_DTIF_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for DMSTS_DTIF_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type DMSTS_ACT_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for DMSTS_ACT_Field use (Val_0 => 0, Val_1 => 1);
   ...
   --  Direct memory access controller 2
   type DMAC2_Peripheral is record
   ...
   --  Direct memory access controller 2
   DMAC2_Periph : aliased DMAC2_Peripheral
   with Import, Address => DMAC2_Base;
