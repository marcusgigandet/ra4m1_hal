...
package R7FA4M1AB.SCI0 is
   ...
   type SSR_FIFO_DR_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for SSR_FIFO_DR_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type SSR_FIFO_TEND_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for SSR_FIFO_TEND_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type SSR_FIFO_PER_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for SSR_FIFO_PER_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type SSR_FIFO_FER_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for SSR_FIFO_FER_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type SSR_FIFO_ORER_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for SSR_FIFO_ORER_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type SSR_FIFO_RDF_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for SSR_FIFO_RDF_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type SSR_FIFO_TDFE_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for SSR_FIFO_TDFE_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type FTDRHL_MPBT_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for FTDRHL_MPBT_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type FTDRH_MPBT_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for FTDRH_MPBT_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type FRDRHL_MPB_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for FRDRHL_MPB_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type FRDRHL_DR_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for FRDRHL_DR_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type FRDRHL_PER_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for FRDRHL_PER_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type FRDRHL_FER_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for FRDRHL_FER_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type FRDRHL_ORER_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for FRDRHL_ORER_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type FRDRHL_RDF_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for FRDRHL_RDF_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type FRDRH_MPB_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for FRDRH_MPB_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type FRDRH_DR_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for FRDRH_DR_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type FRDRH_PER_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for FRDRH_PER_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type FRDRH_FER_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for FRDRH_FER_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type FRDRH_ORER_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for FRDRH_ORER_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type FRDRH_RDF_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for FRDRH_RDF_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type FCR_FM_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for FCR_FM_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type FCR_RFRST_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for FCR_RFRST_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type FCR_TFRST_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for FCR_TFRST_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type FCR_DRES_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for FCR_DRES_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type FCR_TTRG_Field is
     ...
     Val_0000,
      ...
      others_k)
   with Size => 4;
   for FCR_TTRG_Field use (Val_0000 => 0, others_k => 15);
   ...
   for FCR_RTRG_Field use
     (Val_0000 => 0, FCR_RTRG_Field_Reset => 8, others_k => 15);
   ...
   for FCR_RSTRG_Field use
     (Val_0000 => 0, others_k => 14, FCR_RSTRG_Field_Reset => 15);
   ...
   type LSR_ORER_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for LSR_ORER_Field use (Val_0 => 0, Val_1 => 1);
   ...
   --  Serial Communication Interface 0
   type SCI0_Peripheral (Discriminent : SCI0_Disc := View_BRR) is record
