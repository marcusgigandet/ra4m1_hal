...
--  length(SCMR.CHR1=1)
   ...
   subtype SCR_CKE_Field is R7FA4M1AB.UInt2;
...
--  length(SMR.CHR=1)
   ...
   subtype SCMR_Reserved_Field is R7FA4M1AB.UInt2;
...
--  256(SMR.BCP[1:0]=11)
   ...
   type SCMR_Register is record
      ...
      Reserved_1 : SCMR_Reserved_Field := 16#3#;
      --  Base Clock Pulse 2 Selects the number of base clock cycles in
      --  combination with the SMR.BCP[1:0] bits
...
--  mode(SCMR.SMIF=0) /Smart card interface mode(SCMR.SMIF=1)
   ...
   subtype SIMR1_IICDL_Field is R7FA4M1AB.UInt5;
...
--  generated.
   ...
   --  SISR_Reserved array
   type SISR_Reserved_Field_Array is array (1 .. 5) of Boolean
...
--  (slave mode).
   ...
   subtype FCR_TTRG_Field is R7FA4M1AB.UInt4;
   subtype FCR_RTRG_Field is R7FA4M1AB.UInt4;
   subtype FCR_RSTRG_Field is R7FA4M1AB.UInt4;
   ...
   subtype LSR_Reserved_Field is R7FA4M1AB.UInt3;
   ...
   --  Serial Communication Interface 0
   type SCI0_Peripheral is record
      --  Serial Mode Register (SCMR.SMIF = 0)
