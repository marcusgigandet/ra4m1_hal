...
package R7FA4M1AB.CAC is
   ...
   type CACR0_CFME_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for CACR0_CFME_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type CACR1_CACREFE_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for CACR1_CACREFE_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type CACR2_RPS_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for CACR2_RPS_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type CAICR_FERRIE_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for CAICR_FERRIE_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type CAICR_MENDIE_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for CAICR_MENDIE_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type CAICR_OVFIE_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for CAICR_OVFIE_Field use (Val_0 => 0, Val_1 => 1);

   subtype CAICR_Reserved_Field is R7FA4M1AB.Bit;
   ...
   type CAICR_FERRFCL_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for CAICR_FERRFCL_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type CAICR_MENDFCL_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for CAICR_MENDFCL_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type CAICR_OVFFCL_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for CAICR_OVFFCL_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type CASTR_FERRF_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for CASTR_FERRF_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type CASTR_MENDF_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for CASTR_MENDF_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type CASTR_OVFF_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for CASTR_OVFF_Field use (Val_0 => 0, Val_1 => 1);
