...
package R7FA4M1AB.GPT321 is
   ...
   type GTWP_WP_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTWP_WP_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTWP_PRKEY_Field is
     ...
     Val_0xA5,
      ...
      others_k)
   with Size => 8;
   for GTWP_PRKEY_Field use (Val_0xA5 => 165, others_k => 255);
   ...
   type GTWP_Register is record
      --  Register Write Disable
      WP         : GTWP_WP_Field := R7FA4M1AB.GPT321.Val_0;
      ...
      PRKEY      : GTWP_PRKEY_Field := R7FA4M1AB.GPT321.others_k;
   ...
   type GTSTR_CSTRT0_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTSTR_CSTRT0_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTSTR_CSTRT1_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTSTR_CSTRT1_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTSTR_CSTRT2_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTSTR_CSTRT2_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTSTR_CSTRT3_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTSTR_CSTRT3_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTSTR_CSTRT4_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTSTR_CSTRT4_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTSTR_CSTRT5_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTSTR_CSTRT5_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTSTR_CSTRT6_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTSTR_CSTRT6_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTSTR_CSTRT7_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTSTR_CSTRT7_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTSTR_Register is record
      --  Channel 0 GTCNT Count Start Read data shows each channel's counter
      --  status (GTCR.CST bit). 0 means counter stop. 1 means counter running.
      CSTRT0   : GTSTR_CSTRT0_Field := R7FA4M1AB.GPT321.Val_0;
      --  Channel 1 GTCNT Count Start Read data shows each channel's counter
      --  status (GTCR.CST bit). 0 means counter stop. 1 means counter running.
      CSTRT1   : GTSTR_CSTRT1_Field := R7FA4M1AB.GPT321.Val_0;
      --  Channel 2 GTCNT Count Start Read data shows each channel's counter
      --  status (GTCR.CST bit). 0 means counter stop. 1 means counter running.
      CSTRT2   : GTSTR_CSTRT2_Field := R7FA4M1AB.GPT321.Val_0;
      --  Channel 3 GTCNT Count Start Read data shows each channel's counter
      --  status (GTCR.CST bit). 0 means counter stop. 1 means counter running.
      CSTRT3   : GTSTR_CSTRT3_Field := R7FA4M1AB.GPT321.Val_0;
      --  Channel 4 GTCNT Count Start Read data shows each channel's counter
      --  status (GTCR.CST bit). 0 means counter stop. 1 means counter running.
      CSTRT4   : GTSTR_CSTRT4_Field := R7FA4M1AB.GPT321.Val_0;
      --  Channel 5 GTCNT Count Start Read data shows each channel's counter
      --  status (GTCR.CST bit). 0 means counter stop. 1 means counter running.
      CSTRT5   : GTSTR_CSTRT5_Field := R7FA4M1AB.GPT321.Val_0;
      --  Channel 6 GTCNT Count Start Read data shows each channel's counter
      --  status (GTCR.CST bit). 0 means counter stop. 1 means counter running.
      CSTRT6   : GTSTR_CSTRT6_Field := R7FA4M1AB.GPT321.Val_0;
      --  Channel 7 GTCNT Count Start Read data shows each channel's counter
      --  status (GTCR.CST bit). 0 means counter stop. 1 means counter running.
      CSTRT7   : GTSTR_CSTRT7_Field := R7FA4M1AB.GPT321.Val_0;
   ...
   type GTSTP_CSTOP0_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTSTP_CSTOP0_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTSTP_CSTOP1_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTSTP_CSTOP1_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTSTP_CSTOP2_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTSTP_CSTOP2_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTSTP_CSTOP3_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTSTP_CSTOP3_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTSTP_CSTOP4_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTSTP_CSTOP4_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTSTP_CSTOP5_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTSTP_CSTOP5_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTSTP_CSTOP6_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTSTP_CSTOP6_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTSTP_CSTOP7_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTSTP_CSTOP7_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTCLR_CCLR0_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTCLR_CCLR0_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTCLR_CCLR1_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTCLR_CCLR1_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTCLR_CCLR2_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTCLR_CCLR2_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTCLR_CCLR3_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTCLR_CCLR3_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTCLR_CCLR4_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTCLR_CCLR4_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTCLR_CCLR5_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTCLR_CCLR5_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTCLR_CCLR6_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTCLR_CCLR6_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTCLR_CCLR7_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTCLR_CCLR7_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTCLR_Register is record
      ...
      CCLR0    : GTCLR_CCLR0_Field := R7FA4M1AB.GPT321.Val_0;
      --  Write-only. Channel 1 GTCNT Count Clear
      CCLR1    : GTCLR_CCLR1_Field := R7FA4M1AB.GPT321.Val_0;
      --  Write-only. Channel 2 GTCNT Count Clear
      CCLR2    : GTCLR_CCLR2_Field := R7FA4M1AB.GPT321.Val_0;
      --  Write-only. Channel 3 GTCNT Count Clear
      CCLR3    : GTCLR_CCLR3_Field := R7FA4M1AB.GPT321.Val_0;
      --  Write-only. Channel 4 GTCNT Count Clear
      CCLR4    : GTCLR_CCLR4_Field := R7FA4M1AB.GPT321.Val_0;
      --  Write-only. Channel 5 GTCNT Count Clear
      CCLR5    : GTCLR_CCLR5_Field := R7FA4M1AB.GPT321.Val_0;
      --  Write-only. Channel 6 GTCNT Count Clear
      CCLR6    : GTCLR_CCLR6_Field := R7FA4M1AB.GPT321.Val_0;
      --  Write-only. Channel 7 GTCNT Count Clear
      CCLR7    : GTCLR_CCLR7_Field := R7FA4M1AB.GPT321.Val_0;
   ...
   type GTSSR_SSGTRGAR_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTSSR_SSGTRGAR_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTSSR_SSGTRGAF_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTSSR_SSGTRGAF_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTSSR_SSGTRGBR_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTSSR_SSGTRGBR_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTSSR_SSGTRGBF_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTSSR_SSGTRGBF_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTSSR_SSCARBL_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTSSR_SSCARBL_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTSSR_SSCARBH_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTSSR_SSCARBH_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTSSR_SSCAFBL_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTSSR_SSCAFBL_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTSSR_SSCAFBH_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTSSR_SSCAFBH_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTSSR_SSCBRAL_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTSSR_SSCBRAL_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTSSR_SSCBRAH_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTSSR_SSCBRAH_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTSSR_SSCBFAL_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTSSR_SSCBFAL_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTSSR_SSCBFAH_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTSSR_SSCBFAH_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTSSR_SSELCA_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTSSR_SSELCA_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTSSR_SSELCB_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTSSR_SSELCB_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTSSR_SSELCC_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTSSR_SSELCC_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTSSR_SSELCD_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTSSR_SSELCD_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTSSR_SSELCE_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTSSR_SSELCE_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTSSR_SSELCF_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTSSR_SSELCF_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTSSR_SSELCG_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTSSR_SSELCG_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTSSR_SSELCH_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTSSR_SSELCH_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTSSR_CSTRT_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTSSR_CSTRT_Field use (Val_0 => 0, Val_1 => 1);

   --  General PWM Timer Start Source Select Register
   type GTSSR_Register is record
      --  GTETRGA Pin Rising Input Source Counter Start Enable
      SSGTRGAR   : GTSSR_SSGTRGAR_Field := R7FA4M1AB.GPT321.Val_0;
      --  GTETRGA Pin Falling Input Source Counter Start Enable
      SSGTRGAF   : GTSSR_SSGTRGAF_Field := R7FA4M1AB.GPT321.Val_0;
      --  GTETRGB Pin Rising Input Source Counter Start Enable
      SSGTRGBR   : GTSSR_SSGTRGBR_Field := R7FA4M1AB.GPT321.Val_0;
      --  GTETRGB Pin Falling Input Source Counter Start Enable
      SSGTRGBF   : GTSSR_SSGTRGBF_Field := R7FA4M1AB.GPT321.Val_0;
      --  These bits are read as 0000. The write value should be 0000.
      Reserved   : GTSSR_Reserved_Field := 16#0#;
      --  GTIOCA Pin Rising Input during GTIOCB Value Low Source Counter Start
      --  Enable
      SSCARBL    : GTSSR_SSCARBL_Field := R7FA4M1AB.GPT321.Val_0;
      --  GTIOCA Pin Rising Input during GTIOCB Value High Source Counter Start
      --  Enable
      SSCARBH    : GTSSR_SSCARBH_Field := R7FA4M1AB.GPT321.Val_0;
      --  GTIOCA Pin Falling Input during GTIOCB Value Low Source Counter Start
      --  Enable
      SSCAFBL    : GTSSR_SSCAFBL_Field := R7FA4M1AB.GPT321.Val_0;
      --  GTIOCA Pin Falling Input during GTIOCB Value High Source Counter
      --  Start Enable
      SSCAFBH    : GTSSR_SSCAFBH_Field := R7FA4M1AB.GPT321.Val_0;
      --  GTIOCB Pin Rising Input during GTIOCA Value Low Source Counter Start
      --  Enable
      SSCBRAL    : GTSSR_SSCBRAL_Field := R7FA4M1AB.GPT321.Val_0;
      --  GTIOCB Pin Rising Input during GTIOCA Value High Source Counter Start
      --  Enable
      SSCBRAH    : GTSSR_SSCBRAH_Field := R7FA4M1AB.GPT321.Val_0;
      --  GTIOCB Pin Falling Input during GTIOCA Value Low Source Counter Start
      --  Enable
      SSCBFAL    : GTSSR_SSCBFAL_Field := R7FA4M1AB.GPT321.Val_0;
      --  GTIOCB Pin Falling Input during GTIOCA Value High Source Counter
      --  Start Enable
      SSCBFAH    : GTSSR_SSCBFAH_Field := R7FA4M1AB.GPT321.Val_0;
      --  ELC_GPTA Event Source Counter Start Enable
      SSELCA     : GTSSR_SSELCA_Field := R7FA4M1AB.GPT321.Val_0;
      --  ELC_GPTB Event Source Counter Start Enable
      SSELCB     : GTSSR_SSELCB_Field := R7FA4M1AB.GPT321.Val_0;
      --  ELC_GPTC Event Source Counter Start Enable
      SSELCC     : GTSSR_SSELCC_Field := R7FA4M1AB.GPT321.Val_0;
      --  ELC_GPTD Event Source Counter Start Enable
      SSELCD     : GTSSR_SSELCD_Field := R7FA4M1AB.GPT321.Val_0;
      --  ELC_GPTE Event Source Counter Start Enable
      SSELCE     : GTSSR_SSELCE_Field := R7FA4M1AB.GPT321.Val_0;
      --  ELC_GPTF Event Source Counter Start Enable
      SSELCF     : GTSSR_SSELCF_Field := R7FA4M1AB.GPT321.Val_0;
      --  ELC_GPTG Event Source Counter Start Enable
      SSELCG     : GTSSR_SSELCG_Field := R7FA4M1AB.GPT321.Val_0;
      --  ELCH Event Source Counter Start Enable
      SSELCH     : GTSSR_SSELCH_Field := R7FA4M1AB.GPT321.Val_0;
      --  These bits are read as 0000000. The write value should be 0000000.
      Reserved_1 : GTSSR_Reserved_Field_1 := 16#0#;
      --  Software Source Counter Start Enable
      CSTRT      : GTSSR_CSTRT_Field := R7FA4M1AB.GPT321.Val_0;
   end record
   with
     Volatile_Full_Access,
     Object_Size => 32,
   ...
   type GTPSR_PSGTRGAR_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTPSR_PSGTRGAR_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTPSR_PSGTRGAF_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTPSR_PSGTRGAF_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTPSR_PSGTRGBR_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTPSR_PSGTRGBR_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTPSR_PSGTRGBF_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTPSR_PSGTRGBF_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTPSR_PSCARBL_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTPSR_PSCARBL_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTPSR_PSCARBH_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTPSR_PSCARBH_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTPSR_PSCAFBL_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTPSR_PSCAFBL_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTPSR_PSCAFBH_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTPSR_PSCAFBH_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTPSR_PSCBRAL_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTPSR_PSCBRAL_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTPSR_PSCBRAH_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTPSR_PSCBRAH_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTPSR_PSCBFAL_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTPSR_PSCBFAL_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTPSR_PSCBFAH_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTPSR_PSCBFAH_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTPSR_PSELCA_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTPSR_PSELCA_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTPSR_PSELCB_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTPSR_PSELCB_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTPSR_PSELCC_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTPSR_PSELCC_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTPSR_PSELCD_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTPSR_PSELCD_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTPSR_PSELCE_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTPSR_PSELCE_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTPSR_PSELCF_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTPSR_PSELCF_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTPSR_PSELCG_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTPSR_PSELCG_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTPSR_PSELCH_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTPSR_PSELCH_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTPSR_CSTOP_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTPSR_CSTOP_Field use (Val_0 => 0, Val_1 => 1);

   --  General PWM Timer Stop Source Select Register
   type GTPSR_Register is record
      --  GTETRGA Pin Rising Input Source Counter Stop Enable
      PSGTRGAR   : GTPSR_PSGTRGAR_Field := R7FA4M1AB.GPT321.Val_0;
      --  GTETRGA Pin Falling Input Source Counter Stop Enable
      PSGTRGAF   : GTPSR_PSGTRGAF_Field := R7FA4M1AB.GPT321.Val_0;
      --  GTETRGB Pin Rising Input Source Counter Stop Enable
      PSGTRGBR   : GTPSR_PSGTRGBR_Field := R7FA4M1AB.GPT321.Val_0;
      --  GTETRGB Pin Falling Input Source Counter Stop Enable
      PSGTRGBF   : GTPSR_PSGTRGBF_Field := R7FA4M1AB.GPT321.Val_0;
      --  These bits are read as 0000. The write value should be 0000.
      Reserved   : GTPSR_Reserved_Field := 16#0#;
      --  GTIOCA Pin Rising Input during GTIOCB Value Low Source Counter Stop
      --  Enable
      PSCARBL    : GTPSR_PSCARBL_Field := R7FA4M1AB.GPT321.Val_0;
      --  GTIOCA Pin Rising Input during GTIOCB Value High Source Counter Stop
      --  Enable
      PSCARBH    : GTPSR_PSCARBH_Field := R7FA4M1AB.GPT321.Val_0;
      --  GTIOCA Pin Falling Input during GTIOCB Value Low Source Counter Stop
      --  Enable
      PSCAFBL    : GTPSR_PSCAFBL_Field := R7FA4M1AB.GPT321.Val_0;
      --  GTIOCA Pin Falling Input during GTIOCB Value High Source Counter Stop
      --  Enable
      PSCAFBH    : GTPSR_PSCAFBH_Field := R7FA4M1AB.GPT321.Val_0;
      --  GTIOCB Pin Rising Input during GTIOCA Value Low Source Counter Stop
      --  Enable
      PSCBRAL    : GTPSR_PSCBRAL_Field := R7FA4M1AB.GPT321.Val_0;
      --  GTIOCB Pin Rising Input during GTIOCA Value High Source Counter Stop
      --  Enable
      PSCBRAH    : GTPSR_PSCBRAH_Field := R7FA4M1AB.GPT321.Val_0;
      --  GTIOCB Pin Falling Input during GTIOCA Value Low Source Counter Stop
      --  Enable
      PSCBFAL    : GTPSR_PSCBFAL_Field := R7FA4M1AB.GPT321.Val_0;
      --  GTIOCB Pin Falling Input during GTIOCA Value High Source Counter Stop
      --  Enable
      PSCBFAH    : GTPSR_PSCBFAH_Field := R7FA4M1AB.GPT321.Val_0;
      --  ELC_GPTA Event Source Counter Stop Enable
      PSELCA     : GTPSR_PSELCA_Field := R7FA4M1AB.GPT321.Val_0;
      --  ELC_GPTB Event Source Counter Stop Enable
      PSELCB     : GTPSR_PSELCB_Field := R7FA4M1AB.GPT321.Val_0;
      --  ELC_GPTC Event Source Counter Stop Enable
      PSELCC     : GTPSR_PSELCC_Field := R7FA4M1AB.GPT321.Val_0;
      --  ELC_GPTD Event Source Counter Stop Enable
      PSELCD     : GTPSR_PSELCD_Field := R7FA4M1AB.GPT321.Val_0;
      --  ELC_GPTE Event Source Counter Stop Enable
      PSELCE     : GTPSR_PSELCE_Field := R7FA4M1AB.GPT321.Val_0;
      --  ELC_GPTF Event Source Counter Stop Enable
      PSELCF     : GTPSR_PSELCF_Field := R7FA4M1AB.GPT321.Val_0;
      --  ELC_GPTG Event Source Counter Stop Enable
      PSELCG     : GTPSR_PSELCG_Field := R7FA4M1AB.GPT321.Val_0;
      --  ELCH Event Source Counter Stop Enable
      PSELCH     : GTPSR_PSELCH_Field := R7FA4M1AB.GPT321.Val_0;
      --  These bits are read as 0000000. The write value should be 0000000.
      Reserved_1 : GTPSR_Reserved_Field_1 := 16#0#;
      --  Software Source Counter Stop Enable
      CSTOP      : GTPSR_CSTOP_Field := R7FA4M1AB.GPT321.Val_0;
   end record
   with
     Volatile_Full_Access,
     Object_Size => 32,
   ...
   type GTCSR_CSGTRGAR_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTCSR_CSGTRGAR_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTCSR_CSGTRGAF_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTCSR_CSGTRGAF_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTCSR_CSGTRGBR_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTCSR_CSGTRGBR_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTCSR_CSGTRGBF_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTCSR_CSGTRGBF_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTCSR_CSCARBL_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTCSR_CSCARBL_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTCSR_CSCARBH_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTCSR_CSCARBH_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTCSR_CSCAFBL_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTCSR_CSCAFBL_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTCSR_CSCAFBH_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTCSR_CSCAFBH_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTCSR_CSCBRAL_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTCSR_CSCBRAL_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTCSR_CSCBRAH_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTCSR_CSCBRAH_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTCSR_CSCBFAL_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTCSR_CSCBFAL_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTCSR_CSCBFAH_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTCSR_CSCBFAH_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTCSR_CSELCA_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTCSR_CSELCA_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTCSR_CSELCB_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTCSR_CSELCB_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTCSR_CSELCC_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTCSR_CSELCC_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTCSR_CSELCD_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTCSR_CSELCD_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTCSR_CSELCE_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTCSR_CSELCE_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTCSR_CSELCF_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTCSR_CSELCF_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTCSR_CSELCG_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTCSR_CSELCG_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTCSR_CSELCH_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTCSR_CSELCH_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTCSR_CCLR_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTCSR_CCLR_Field use (Val_0 => 0, Val_1 => 1);

   --  General PWM Timer Clear Source Select Register
   type GTCSR_Register is record
      --  GTETRGA Pin Rising Input Source Counter Clear Enable
      CSGTRGAR   : GTCSR_CSGTRGAR_Field := R7FA4M1AB.GPT321.Val_0;
      --  GTETRGA Pin Falling Input Source Counter Clear Enable
      CSGTRGAF   : GTCSR_CSGTRGAF_Field := R7FA4M1AB.GPT321.Val_0;
      --  GTETRGB Pin Rising Input Source Counter Clear Enable
      CSGTRGBR   : GTCSR_CSGTRGBR_Field := R7FA4M1AB.GPT321.Val_0;
      --  GTETRGB Pin Falling Input Source Counter Clear Enable
      CSGTRGBF   : GTCSR_CSGTRGBF_Field := R7FA4M1AB.GPT321.Val_0;
      --  These bits are read as 0000. The write value should be 0000.
      Reserved   : GTCSR_Reserved_Field := 16#0#;
      --  GTIOCA Pin Rising Input during GTIOCB Value Low Source Counter Clear
      --  Enable
      CSCARBL    : GTCSR_CSCARBL_Field := R7FA4M1AB.GPT321.Val_0;
      --  GTIOCA Pin Rising Input during GTIOCB Value High Source Counter Clear
      --  Enable
      CSCARBH    : GTCSR_CSCARBH_Field := R7FA4M1AB.GPT321.Val_0;
      --  GTIOCA Pin Falling Input during GTIOCB Value Low Source Counter Clear
      --  Enable
      CSCAFBL    : GTCSR_CSCAFBL_Field := R7FA4M1AB.GPT321.Val_0;
      --  GTIOCA Pin Falling Input during GTIOCB Value High Source Counter
      --  Clear Enable
      CSCAFBH    : GTCSR_CSCAFBH_Field := R7FA4M1AB.GPT321.Val_0;
      --  GTIOCB Pin Rising Input during GTIOCA Value Low Source Counter Clear
      --  Enable
      CSCBRAL    : GTCSR_CSCBRAL_Field := R7FA4M1AB.GPT321.Val_0;
      --  GTIOCB Pin Rising Input during GTIOCA Value High Source Counter Clear
      --  Enable
      CSCBRAH    : GTCSR_CSCBRAH_Field := R7FA4M1AB.GPT321.Val_0;
      --  GTIOCB Pin Falling Input during GTIOCA Value Low Source Counter Clear
      --  Enable
      CSCBFAL    : GTCSR_CSCBFAL_Field := R7FA4M1AB.GPT321.Val_0;
      --  GTIOCB Pin Falling Input during GTIOCA Value High Source Counter
      --  Clear Enable
      CSCBFAH    : GTCSR_CSCBFAH_Field := R7FA4M1AB.GPT321.Val_0;
      --  ELC_GPTA Event Source Counter Clear Enable
      CSELCA     : GTCSR_CSELCA_Field := R7FA4M1AB.GPT321.Val_0;
      --  ELC_GPTB Event Source Counter Clear Enable
      CSELCB     : GTCSR_CSELCB_Field := R7FA4M1AB.GPT321.Val_0;
      --  ELC_GPTC Event Source Counter Clear Enable
      CSELCC     : GTCSR_CSELCC_Field := R7FA4M1AB.GPT321.Val_0;
      --  ELC_GPTD Event Source Counter Clear Enable
      CSELCD     : GTCSR_CSELCD_Field := R7FA4M1AB.GPT321.Val_0;
      --  ELC_GPTE Event Source Counter Clear Enable
      CSELCE     : GTCSR_CSELCE_Field := R7FA4M1AB.GPT321.Val_0;
      --  ELC_GPTF Event Source Counter Clear Enable
      CSELCF     : GTCSR_CSELCF_Field := R7FA4M1AB.GPT321.Val_0;
      --  ELC_GPTG Event Source Counter Clear Enable
      CSELCG     : GTCSR_CSELCG_Field := R7FA4M1AB.GPT321.Val_0;
      --  ELCH Event Source Counter Clear Enable
      CSELCH     : GTCSR_CSELCH_Field := R7FA4M1AB.GPT321.Val_0;
      --  These bits are read as 0000000. The write value should be 0000000.
      Reserved_1 : GTCSR_Reserved_Field_1 := 16#0#;
      --  Software Source Counter Clear Enable
      CCLR       : GTCSR_CCLR_Field := R7FA4M1AB.GPT321.Val_0;
   end record
   with
     Volatile_Full_Access,
     Object_Size => 32,
   ...
   type GTUPSR_USGTRGAR_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTUPSR_USGTRGAR_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTUPSR_USGTRGAF_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTUPSR_USGTRGAF_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTUPSR_USGTRGBR_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTUPSR_USGTRGBR_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTUPSR_USGTRGBF_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTUPSR_USGTRGBF_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTUPSR_USCARBL_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTUPSR_USCARBL_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTUPSR_USCARBH_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTUPSR_USCARBH_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTUPSR_USCAFBL_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTUPSR_USCAFBL_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTUPSR_USCAFBH_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTUPSR_USCAFBH_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTUPSR_USCBRAL_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTUPSR_USCBRAL_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTUPSR_USCBRAH_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTUPSR_USCBRAH_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTUPSR_USCBFAL_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTUPSR_USCBFAL_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTUPSR_USCBFAH_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTUPSR_USCBFAH_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTUPSR_USELCA_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTUPSR_USELCA_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTUPSR_USELCB_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTUPSR_USELCB_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTUPSR_USELCC_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTUPSR_USELCC_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTUPSR_USELCD_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTUPSR_USELCD_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTUPSR_USELCE_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTUPSR_USELCE_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTUPSR_USELCF_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTUPSR_USELCF_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTUPSR_USELCG_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTUPSR_USELCG_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTUPSR_USELCH_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTUPSR_USELCH_Field use (Val_0 => 0, Val_1 => 1);

   --  General PWM Timer Up Count Source Select Register
   type GTUPSR_Register is record
      --  GTETRGA Pin Rising Input Source Counter Count Up Enable
      USGTRGAR       : GTUPSR_USGTRGAR_Field := R7FA4M1AB.GPT321.Val_0;
      --  GTETRGA Pin Falling Input Source Counter Count Up Enable
      USGTRGAF       : GTUPSR_USGTRGAF_Field := R7FA4M1AB.GPT321.Val_0;
      --  GTETRGB Pin Rising Input Source Counter Count Up Enable
      USGTRGBR       : GTUPSR_USGTRGBR_Field := R7FA4M1AB.GPT321.Val_0;
      --  GTETRGB Pin Falling Input Source Counter Count Up Enable
      USGTRGBF       : GTUPSR_USGTRGBF_Field := R7FA4M1AB.GPT321.Val_0;
      --  unspecified
      Reserved_4_7   : R7FA4M1AB.UInt4 := 16#0#;
      --  GTIOCA Pin Rising Input during GTIOCB Value Low Source Counter Count
      --  Up Enable
      USCARBL        : GTUPSR_USCARBL_Field := R7FA4M1AB.GPT321.Val_0;
      --  GTIOCA Pin Rising Input during GTIOCB Value High Source Counter Count
      --  Up Enable
      USCARBH        : GTUPSR_USCARBH_Field := R7FA4M1AB.GPT321.Val_0;
      --  GTIOCA Pin Falling Input during GTIOCB Value Low Source Counter Count
      --  Up Enable
      USCAFBL        : GTUPSR_USCAFBL_Field := R7FA4M1AB.GPT321.Val_0;
      --  GTIOCA Pin Falling Input during GTIOCB Value High Source Counter
      --  Count Up Enable
      USCAFBH        : GTUPSR_USCAFBH_Field := R7FA4M1AB.GPT321.Val_0;
      --  GTIOCB Pin Rising Input during GTIOCA Value Low Source Counter Count
      --  Up Enable
      USCBRAL        : GTUPSR_USCBRAL_Field := R7FA4M1AB.GPT321.Val_0;
      --  GTIOCB Pin Rising Input during GTIOCA Value High Source Counter Count
      --  Up Enable
      USCBRAH        : GTUPSR_USCBRAH_Field := R7FA4M1AB.GPT321.Val_0;
      --  GTIOCB Pin Falling Input during GTIOCA Value Low Source Counter Count
      --  Up Enable
      USCBFAL        : GTUPSR_USCBFAL_Field := R7FA4M1AB.GPT321.Val_0;
      --  GTIOCB Pin Falling Input during GTIOCA Value High Source Counter
      --  Count Up Enable
      USCBFAH        : GTUPSR_USCBFAH_Field := R7FA4M1AB.GPT321.Val_0;
      --  ELC_GPTA Event Source Counter Count Up Enable
      USELCA         : GTUPSR_USELCA_Field := R7FA4M1AB.GPT321.Val_0;
      --  ELC_GPTB Event Source Counter Count Up Enable
      USELCB         : GTUPSR_USELCB_Field := R7FA4M1AB.GPT321.Val_0;
      --  ELC_GPTC Event Source Counter Count Up Enable
      USELCC         : GTUPSR_USELCC_Field := R7FA4M1AB.GPT321.Val_0;
      --  ELC_GPTD Event Source Counter Count Up Enable
      USELCD         : GTUPSR_USELCD_Field := R7FA4M1AB.GPT321.Val_0;
      --  ELC_GPTE Event Source Counter Count Up Enable
      USELCE         : GTUPSR_USELCE_Field := R7FA4M1AB.GPT321.Val_0;
      --  ELC_GPTF Event Source Counter Count Up Enable
      USELCF         : GTUPSR_USELCF_Field := R7FA4M1AB.GPT321.Val_0;
      --  ELC_GPTG Event Source Counter Count Up Enable
      USELCG         : GTUPSR_USELCG_Field := R7FA4M1AB.GPT321.Val_0;
      --  ELCH Event Source Counter Count Up Enable
      USELCH         : GTUPSR_USELCH_Field := R7FA4M1AB.GPT321.Val_0;
      --  unspecified
   ...
   type GTDNSR_DSGTRGAR_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTDNSR_DSGTRGAR_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTDNSR_DSGTRGAF_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTDNSR_DSGTRGAF_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTDNSR_DSGTRGBR_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTDNSR_DSGTRGBR_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTDNSR_DSGTRGBF_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTDNSR_DSGTRGBF_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTDNSR_DSCARBL_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTDNSR_DSCARBL_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTDNSR_DSCARBH_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTDNSR_DSCARBH_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTDNSR_DSCAFBL_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTDNSR_DSCAFBL_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTDNSR_DSCAFBH_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTDNSR_DSCAFBH_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTDNSR_DSCBRAL_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTDNSR_DSCBRAL_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTDNSR_DSCBRAH_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTDNSR_DSCBRAH_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTDNSR_DSCBFAL_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTDNSR_DSCBFAL_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTDNSR_DSCBFAH_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTDNSR_DSCBFAH_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTDNSR_DSELCA_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTDNSR_DSELCA_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTDNSR_DSELCB_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTDNSR_DSELCB_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTDNSR_DSELCC_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTDNSR_DSELCC_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTDNSR_DSELCD_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTDNSR_DSELCD_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTDNSR_DSELCE_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTDNSR_DSELCE_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTDNSR_DSELCF_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTDNSR_DSELCF_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTDNSR_DSELCG_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTDNSR_DSELCG_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTDNSR_DSELCH_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTDNSR_DSELCH_Field use (Val_0 => 0, Val_1 => 1);

   --  General PWM Timer Down Count Source Select Register
   type GTDNSR_Register is record
      --  GTETRGA Pin Rising Input Source Counter Count Down Enable
      DSGTRGAR       : GTDNSR_DSGTRGAR_Field := R7FA4M1AB.GPT321.Val_0;
      --  GTETRGA Pin Falling Input Source Counter Count Down Enable
      DSGTRGAF       : GTDNSR_DSGTRGAF_Field := R7FA4M1AB.GPT321.Val_0;
      --  GTETRGB Pin Rising Input Source Counter Count Down Enable
      DSGTRGBR       : GTDNSR_DSGTRGBR_Field := R7FA4M1AB.GPT321.Val_0;
      --  GTETRGB Pin Falling Input Source Counter Count Down Enable
      DSGTRGBF       : GTDNSR_DSGTRGBF_Field := R7FA4M1AB.GPT321.Val_0;
      --  unspecified
      Reserved_4_7   : R7FA4M1AB.UInt4 := 16#0#;
      --  GTIOCA Pin Rising Input during GTIOCB Value Low Source Counter Count
      --  Down Enable
      DSCARBL        : GTDNSR_DSCARBL_Field := R7FA4M1AB.GPT321.Val_0;
      --  GTIOCA Pin Rising Input during GTIOCB Value High Source Counter Count
      --  Down Enable
      DSCARBH        : GTDNSR_DSCARBH_Field := R7FA4M1AB.GPT321.Val_0;
      --  GTIOCA Pin Falling Input during GTIOCB Value Low Source Counter Count
      --  Down Enable
      DSCAFBL        : GTDNSR_DSCAFBL_Field := R7FA4M1AB.GPT321.Val_0;
      --  GTIOCA Pin Falling Input during GTIOCB Value High Source Counter
      --  Count Down Enable
      DSCAFBH        : GTDNSR_DSCAFBH_Field := R7FA4M1AB.GPT321.Val_0;
      --  GTIOCB Pin Rising Input during GTIOCA Value Low Source Counter Count
      --  Down Enable
      DSCBRAL        : GTDNSR_DSCBRAL_Field := R7FA4M1AB.GPT321.Val_0;
      --  GTIOCB Pin Rising Input during GTIOCA Value High Source Counter Count
      --  Down Enable
      DSCBRAH        : GTDNSR_DSCBRAH_Field := R7FA4M1AB.GPT321.Val_0;
      --  GTIOCB Pin Falling Input during GTIOCA Value Low Source Counter Count
      --  Down Enable
      DSCBFAL        : GTDNSR_DSCBFAL_Field := R7FA4M1AB.GPT321.Val_0;
      --  GTIOCB Pin Falling Input during GTIOCA Value High Source Counter
      --  Count Down Enable
      DSCBFAH        : GTDNSR_DSCBFAH_Field := R7FA4M1AB.GPT321.Val_0;
      --  ELC_GPTA Event Source Counter Count Down Enable
      DSELCA         : GTDNSR_DSELCA_Field := R7FA4M1AB.GPT321.Val_0;
      --  ELC_GPTB Event Source Counter Count Down Enable
      DSELCB         : GTDNSR_DSELCB_Field := R7FA4M1AB.GPT321.Val_0;
      --  ELC_GPTC Event Source Counter Count Down Enable
      DSELCC         : GTDNSR_DSELCC_Field := R7FA4M1AB.GPT321.Val_0;
      --  ELC_GPTD Event Source Counter Count Down Enable
      DSELCD         : GTDNSR_DSELCD_Field := R7FA4M1AB.GPT321.Val_0;
      --  ELC_GPTE Event Source Counter Count Down Enable
      DSELCE         : GTDNSR_DSELCE_Field := R7FA4M1AB.GPT321.Val_0;
      --  ELC_GPTF Event Source Counter Count Down Enable
      DSELCF         : GTDNSR_DSELCF_Field := R7FA4M1AB.GPT321.Val_0;
      --  ELC_GPTG Event Source Counter Count Down Enable
      DSELCG         : GTDNSR_DSELCG_Field := R7FA4M1AB.GPT321.Val_0;
      --  ELCH Event Source Counter Count Down Enable
      DSELCH         : GTDNSR_DSELCH_Field := R7FA4M1AB.GPT321.Val_0;
      --  unspecified
      Reserved_24_31 : R7FA4M1AB.Byte := 16#0#;
   end record
   with
   ...
   type GTICASR_ASGTRGAR_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTICASR_ASGTRGAR_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTICASR_ASGTRGAF_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTICASR_ASGTRGAF_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTICASR_ASGTRGBR_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTICASR_ASGTRGBR_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTICASR_ASGTRGBF_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTICASR_ASGTRGBF_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTICASR_ASCARBL_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTICASR_ASCARBL_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTICASR_ASCARBH_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTICASR_ASCARBH_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTICASR_ASCAFBL_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTICASR_ASCAFBL_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTICASR_ASCAFBH_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTICASR_ASCAFBH_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTICASR_ASCBRAL_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTICASR_ASCBRAL_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTICASR_ASCBRAH_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTICASR_ASCBRAH_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTICASR_ASCBFAL_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTICASR_ASCBFAL_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTICASR_ASCBFAH_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTICASR_ASCBFAH_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTICASR_ASELCA_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTICASR_ASELCA_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTICASR_ASELCB_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTICASR_ASELCB_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTICASR_ASELCC_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTICASR_ASELCC_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTICASR_ASELCD_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTICASR_ASELCD_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTICASR_ASELCE_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTICASR_ASELCE_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTICASR_ASELCF_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTICASR_ASELCF_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTICASR_ASELCG_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTICASR_ASELCG_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTICASR_ASELCH_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTICASR_ASELCH_Field use (Val_0 => 0, Val_1 => 1);

   --  General PWM Timer Input Capture Source Select Register A
   type GTICASR_Register is record
      --  GTETRGA Pin Rising Input Source GTCCRA Input Capture Enable
      ASGTRGAR       : GTICASR_ASGTRGAR_Field := R7FA4M1AB.GPT321.Val_0;
      --  GTETRGA Pin Falling Input Source GTCCRA Input Capture Enable
      ASGTRGAF       : GTICASR_ASGTRGAF_Field := R7FA4M1AB.GPT321.Val_0;
      --  GTETRGB Pin Rising Input Source GTCCRA Input Capture Enable
      ASGTRGBR       : GTICASR_ASGTRGBR_Field := R7FA4M1AB.GPT321.Val_0;
      --  GTETRGB Pin Falling Input Source GTCCRA Input Capture Enable
      ASGTRGBF       : GTICASR_ASGTRGBF_Field := R7FA4M1AB.GPT321.Val_0;
      --  unspecified
      Reserved_4_7   : R7FA4M1AB.UInt4 := 16#0#;
      --  GTIOCA Pin Rising Input during GTIOCB Value Low Source GTCCRA Input
      --  Capture Enable
      ASCARBL        : GTICASR_ASCARBL_Field := R7FA4M1AB.GPT321.Val_0;
      --  GTIOCA Pin Rising Input during GTIOCB Value High Source GTCCRA Input
      --  Capture Enable
      ASCARBH        : GTICASR_ASCARBH_Field := R7FA4M1AB.GPT321.Val_0;
      --  GTIOCA Pin Falling Input during GTIOCB Value Low Source GTCCRA Input
      --  Capture Enable
      ASCAFBL        : GTICASR_ASCAFBL_Field := R7FA4M1AB.GPT321.Val_0;
      --  GTIOCA Pin Falling Input during GTIOCB Value High Source GTCCRA Input
      --  Capture Enable
      ASCAFBH        : GTICASR_ASCAFBH_Field := R7FA4M1AB.GPT321.Val_0;
      --  GTIOCB Pin Rising Input during GTIOCA Value Low Source GTCCRA Input
      --  Capture Enable
      ASCBRAL        : GTICASR_ASCBRAL_Field := R7FA4M1AB.GPT321.Val_0;
      --  GTIOCB Pin Rising Input during GTIOCA Value High Source GTCCRA Input
      --  Capture Enable
      ASCBRAH        : GTICASR_ASCBRAH_Field := R7FA4M1AB.GPT321.Val_0;
      --  GTIOCB Pin Falling Input during GTIOCA Value Low Source GTCCRA Input
      --  Capture Enable
      ASCBFAL        : GTICASR_ASCBFAL_Field := R7FA4M1AB.GPT321.Val_0;
      --  GTIOCB Pin Falling Input during GTIOCA Value High Source GTCCRA Input
      --  Capture Enable
      ASCBFAH        : GTICASR_ASCBFAH_Field := R7FA4M1AB.GPT321.Val_0;
      --  ELC_GPTA Event Source GTCCRA Input Capture Enable
      ASELCA         : GTICASR_ASELCA_Field := R7FA4M1AB.GPT321.Val_0;
      --  ELC_GPTB Event Source GTCCRA Input Capture Enable
      ASELCB         : GTICASR_ASELCB_Field := R7FA4M1AB.GPT321.Val_0;
      --  ELC_GPTC Event Source GTCCRA Input Capture Enable
      ASELCC         : GTICASR_ASELCC_Field := R7FA4M1AB.GPT321.Val_0;
      --  ELC_GPTD Event Source GTCCRA Input Capture Enable
      ASELCD         : GTICASR_ASELCD_Field := R7FA4M1AB.GPT321.Val_0;
      --  ELC_GPTE Event Source GTCCRA Input Capture Enable
      ASELCE         : GTICASR_ASELCE_Field := R7FA4M1AB.GPT321.Val_0;
      --  ELC_GPTF Event Source GTCCRA Input Capture Enable
      ASELCF         : GTICASR_ASELCF_Field := R7FA4M1AB.GPT321.Val_0;
      --  ELC_GPTG Event Source GTCCRA Input Capture Enable
      ASELCG         : GTICASR_ASELCG_Field := R7FA4M1AB.GPT321.Val_0;
      --  ELCH Event Source GTCCRA Input Capture Enable
      ASELCH         : GTICASR_ASELCH_Field := R7FA4M1AB.GPT321.Val_0;
      --  unspecified
      Reserved_24_31 : R7FA4M1AB.Byte := 16#0#;
   end record
   with
   ...
   type GTICBSR_BSGTRGAR_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTICBSR_BSGTRGAR_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTICBSR_BSGTRGAF_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTICBSR_BSGTRGAF_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTICBSR_BSGTRGBR_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTICBSR_BSGTRGBR_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTICBSR_BSGTRGBF_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTICBSR_BSGTRGBF_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTICBSR_BSCARBL_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTICBSR_BSCARBL_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTICBSR_BSCARBH_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTICBSR_BSCARBH_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTICBSR_BSCAFBL_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTICBSR_BSCAFBL_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTICBSR_BSCAFBH_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTICBSR_BSCAFBH_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTICBSR_BSCBRAL_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTICBSR_BSCBRAL_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTICBSR_BSCBRAH_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTICBSR_BSCBRAH_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTICBSR_BSCBFAL_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTICBSR_BSCBFAL_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTICBSR_BSCBFAH_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTICBSR_BSCBFAH_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTICBSR_BSELCA_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTICBSR_BSELCA_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTICBSR_BSELCB_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTICBSR_BSELCB_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTICBSR_BSELCC_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTICBSR_BSELCC_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTICBSR_BSELCD_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTICBSR_BSELCD_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTICBSR_BSELCE_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTICBSR_BSELCE_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTICBSR_BSELCF_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTICBSR_BSELCF_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTICBSR_BSELCG_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTICBSR_BSELCG_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTICBSR_BSELCH_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTICBSR_BSELCH_Field use (Val_0 => 0, Val_1 => 1);

   --  General PWM Timer Input Capture Source Select Register B
   type GTICBSR_Register is record
      --  GTETRGA Pin Rising Input Source GTCCRB Input Capture Enable
      BSGTRGAR       : GTICBSR_BSGTRGAR_Field := R7FA4M1AB.GPT321.Val_0;
      --  GTETRGA Pin Falling Input Source GTCCRB Input Capture Enable
      BSGTRGAF       : GTICBSR_BSGTRGAF_Field := R7FA4M1AB.GPT321.Val_0;
      --  GTETRGB Pin Rising Input Source GTCCRB Input Capture Enable
      BSGTRGBR       : GTICBSR_BSGTRGBR_Field := R7FA4M1AB.GPT321.Val_0;
      --  GTETRGB Pin Falling Input Source GTCCRB Input Capture Enable
      BSGTRGBF       : GTICBSR_BSGTRGBF_Field := R7FA4M1AB.GPT321.Val_0;
      --  unspecified
      Reserved_4_7   : R7FA4M1AB.UInt4 := 16#0#;
      --  GTIOCA Pin Rising Input during GTIOCB Value Low Source GTCCRB Input
      --  Capture Enable
      BSCARBL        : GTICBSR_BSCARBL_Field := R7FA4M1AB.GPT321.Val_0;
      --  GTIOCA Pin Rising Input during GTIOCB Value High Source GTCCRB Input
      --  Capture Enable
      BSCARBH        : GTICBSR_BSCARBH_Field := R7FA4M1AB.GPT321.Val_0;
      --  GTIOCA Pin Falling Input during GTIOCB Value Low Source GTCCRB Input
      --  Capture Enable
      BSCAFBL        : GTICBSR_BSCAFBL_Field := R7FA4M1AB.GPT321.Val_0;
      --  GTIOCA Pin Falling Input during GTIOCB Value High Source GTCCRB Input
      --  Capture Enable
      BSCAFBH        : GTICBSR_BSCAFBH_Field := R7FA4M1AB.GPT321.Val_0;
      --  GTIOCB Pin Rising Input during GTIOCA Value Low Source GTCCRB Input
      --  Capture Enable
      BSCBRAL        : GTICBSR_BSCBRAL_Field := R7FA4M1AB.GPT321.Val_0;
      --  GTIOCB Pin Rising Input during GTIOCA Value High Source GTCCRB Input
      --  Capture Enable
      BSCBRAH        : GTICBSR_BSCBRAH_Field := R7FA4M1AB.GPT321.Val_0;
      --  GTIOCB Pin Falling Input during GTIOCA Value Low Source GTCCRB Input
      --  Capture Enable
      BSCBFAL        : GTICBSR_BSCBFAL_Field := R7FA4M1AB.GPT321.Val_0;
      --  GTIOCB Pin Falling Input during GTIOCA Value High Source GTCCRB Input
      --  Capture Enable
      BSCBFAH        : GTICBSR_BSCBFAH_Field := R7FA4M1AB.GPT321.Val_0;
      --  ELC_GPTA Event Source GTCCRB Input Capture Enable
      BSELCA         : GTICBSR_BSELCA_Field := R7FA4M1AB.GPT321.Val_0;
      --  ELC_GPTB Event Source GTCCRB Input Capture Enable
      BSELCB         : GTICBSR_BSELCB_Field := R7FA4M1AB.GPT321.Val_0;
      --  ELC_GPTC Event Source GTCCRB Input Capture Enable
      BSELCC         : GTICBSR_BSELCC_Field := R7FA4M1AB.GPT321.Val_0;
      --  ELC_GPTD Event Source GTCCRB Input Capture Enable
      BSELCD         : GTICBSR_BSELCD_Field := R7FA4M1AB.GPT321.Val_0;
      --  ELC_GPTE Event Source GTCCRB Input Capture Enable
      BSELCE         : GTICBSR_BSELCE_Field := R7FA4M1AB.GPT321.Val_0;
      --  ELC_GPTF Event Source GTCCRB Input Capture Enable
      BSELCF         : GTICBSR_BSELCF_Field := R7FA4M1AB.GPT321.Val_0;
      --  ELC_GPTG Event Source GTCCRB Input Capture Enable
      BSELCG         : GTICBSR_BSELCG_Field := R7FA4M1AB.GPT321.Val_0;
      --  ELCH Event Source GTCCRB Input Capture Enable
      BSELCH         : GTICBSR_BSELCH_Field := R7FA4M1AB.GPT321.Val_0;
      --  unspecified
      Reserved_24_31 : R7FA4M1AB.Byte := 16#0#;
   end record
   with
   ...
   type GTCR_CST_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTCR_CST_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTUDDTYC_UD_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTUDDTYC_UD_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTUDDTYC_UDF_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTUDDTYC_UDF_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTUDDTYC_OADTYF_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTUDDTYC_OADTYF_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTUDDTYC_OADTYR_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTUDDTYC_OADTYR_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTUDDTYC_OBDTYF_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTUDDTYC_OBDTYF_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTUDDTYC_OBDTYR_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTUDDTYC_OBDTYR_Field use (Val_0 => 0, Val_1 => 1);

   --  General PWM Timer Count Direction and Duty Setting Register
   type GTUDDTYC_Register is record
      --  Count Direction Setting
      UD             : GTUDDTYC_UD_Field := R7FA4M1AB.GPT321.Val_1;
      --  Forcible Count Direction Setting
      UDF            : GTUDDTYC_UDF_Field := R7FA4M1AB.GPT321.Val_0;
      --  unspecified
      Reserved_2_15  : R7FA4M1AB.UInt14 := 16#0#;
      --  GTIOCA Output Duty Setting
      OADTY          : GTUDDTYC_OADTY_Field := R7FA4M1AB.GPT321.Val_00;
      --  Forcible GTIOCA Output Duty Setting
      OADTYF         : GTUDDTYC_OADTYF_Field := R7FA4M1AB.GPT321.Val_0;
      --  GTIOCA Output Value Selecting after Releasing 0 percent/100 percent
      --  Duty Setting
      OADTYR         : GTUDDTYC_OADTYR_Field := R7FA4M1AB.GPT321.Val_0;
      --  These bits are read as 0000. The write value should be 0000.
      Reserved       : GTUDDTYC_Reserved_Field := 16#0#;
      --  GTIOCB Output Duty Setting
      OBDTY          : GTUDDTYC_OBDTY_Field := R7FA4M1AB.GPT321.Val_00;
      --  Forcible GTIOCB Output Duty Setting
      OBDTYF         : GTUDDTYC_OBDTYF_Field := R7FA4M1AB.GPT321.Val_0;
      --  GTIOCB Output Value Selecting after Releasing 0 percent/100 percent
      --  Duty Setting
      OBDTYR         : GTUDDTYC_OBDTYR_Field := R7FA4M1AB.GPT321.Val_0;
      --  unspecified
   ...
   subtype GTIOR_Reserved_Field is R7FA4M1AB.Bit;
   ...
   type GTIOR_OADFLT_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTIOR_OADFLT_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTIOR_OAHLD_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTIOR_OAHLD_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTIOR_OAE_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTIOR_OAE_Field use (Val_0 => 0, Val_1 => 1);
   ...
   subtype GTIOR_Reserved_Field_1 is R7FA4M1AB.UInt2;
   ...
   type GTIOR_NFAEN_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTIOR_NFAEN_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTIOR_OBDFLT_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTIOR_OBDFLT_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTIOR_OBHLD_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTIOR_OBHLD_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTIOR_OBE_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTIOR_OBE_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTIOR_NFBEN_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTIOR_NFBEN_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTIOR_Register is record
      --  GTIOCA Pin Function Select
      GTIOA      : GTIOR_GTIOA_Field := R7FA4M1AB.GPT321.Val_00000;
      --  This bit is read as 0. The write value should be 0.
      Reserved   : GTIOR_Reserved_Field := 16#0#;
      --  GTIOCA Pin Output Value Setting at the Count Stop
      OADFLT     : GTIOR_OADFLT_Field := R7FA4M1AB.GPT321.Val_0;
      --  GTIOCA Pin Output Setting at the Start/Stop Count
      OAHLD      : GTIOR_OAHLD_Field := R7FA4M1AB.GPT321.Val_0;
      --  GTIOCA Pin Output Enable
      OAE        : GTIOR_OAE_Field := R7FA4M1AB.GPT321.Val_0;
      --  GTIOCA Pin Disable Value Setting
      OADF       : GTIOR_OADF_Field := R7FA4M1AB.GPT321.Val_00;
      --  These bits are read as 00. The write value should be 00.
      Reserved_1 : GTIOR_Reserved_Field_1 := 16#0#;
      --  Noise Filter A Enable
      NFAEN      : GTIOR_NFAEN_Field := R7FA4M1AB.GPT321.Val_0;
      --  Noise Filter A Sampling Clock Select
      NFCSA      : GTIOR_NFCSA_Field := R7FA4M1AB.GPT321.Val_00;
      --  GTIOCB Pin Function Select
      GTIOB      : GTIOR_GTIOB_Field := R7FA4M1AB.GPT321.Val_00000;
      --  This bit is read as 0. The write value should be 0.
      Reserved_2 : GTIOR_Reserved_Field := 16#0#;
      --  GTIOCB Pin Output Value Setting at the Count Stop
      OBDFLT     : GTIOR_OBDFLT_Field := R7FA4M1AB.GPT321.Val_0;
      --  GTIOCB Pin Output Setting at the Start/Stop Count
      OBHLD      : GTIOR_OBHLD_Field := R7FA4M1AB.GPT321.Val_0;
      --  GTIOCB Pin Output Enable
      OBE        : GTIOR_OBE_Field := R7FA4M1AB.GPT321.Val_0;
      --  GTIOCB Pin Disable Value Setting
      OBDF       : GTIOR_OBDF_Field := R7FA4M1AB.GPT321.Val_00;
      --  These bits are read as 00. The write value should be 00.
      Reserved_3 : GTIOR_Reserved_Field_1 := 16#0#;
      --  Noise Filter B Enable
      NFBEN      : GTIOR_NFBEN_Field := R7FA4M1AB.GPT321.Val_0;
      --  Noise Filter B Sampling Clock Select
      NFCSB      : GTIOR_NFCSB_Field := R7FA4M1AB.GPT321.Val_00;
   end record
   with
     Volatile_Full_Access,
     Object_Size => 32,
   ...
   type GTINTAD_GRP_Field is
     ...
     Val_00,
      ...
      others_k)
   with Size => 2;
   for GTINTAD_GRP_Field use (Val_00 => 0, Val_01 => 1, others_k => 3);
   ...
   type GTINTAD_GRPABH_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTINTAD_GRPABH_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTINTAD_GRPABL_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTINTAD_GRPABL_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTINTAD_Register is record
      ...
      --  Output Disable Source Select
      GRP            : GTINTAD_GRP_Field := R7FA4M1AB.GPT321.Val_00;
      --  These bits are read as 000. The write value should be 000.
      Reserved_1     : GTINTAD_Reserved_Field_1 := 16#0#;
      --  Same Time Output Level High Disable Request Enable
      GRPABH         : GTINTAD_GRPABH_Field := R7FA4M1AB.GPT321.Val_0;
      --  Same Time Output Level Low Disable Request Enable
      GRPABL         : GTINTAD_GRPABL_Field := R7FA4M1AB.GPT321.Val_0;
      --  unspecified
   ...
   type GTST_TCFA_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTST_TCFA_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTST_TCFB_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTST_TCFB_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTST_TCFC_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTST_TCFC_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTST_TCFD_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTST_TCFD_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTST_TCFE_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTST_TCFE_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTST_TCFF_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTST_TCFF_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTST_TCFPO_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTST_TCFPO_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTST_TCFPU_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTST_TCFPU_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTST_TUCF_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTST_TUCF_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTST_ODF_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTST_ODF_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTST_OABHF_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTST_OABHF_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTST_OABLF_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTST_OABLF_Field use (Val_0 => 0, Val_1 => 1);

   --  General PWM Timer Status Register
   type GTST_Register is record
      --  Input Capture/Compare Match Flag A
      TCFA           : GTST_TCFA_Field := R7FA4M1AB.GPT321.Val_0;
      --  Input Capture/Compare Match Flag B
      TCFB           : GTST_TCFB_Field := R7FA4M1AB.GPT321.Val_0;
      --  Input Compare Match Flag C
      TCFC           : GTST_TCFC_Field := R7FA4M1AB.GPT321.Val_0;
      --  Input Compare Match Flag D
      TCFD           : GTST_TCFD_Field := R7FA4M1AB.GPT321.Val_0;
      --  Input Compare Match Flag E
      TCFE           : GTST_TCFE_Field := R7FA4M1AB.GPT321.Val_0;
      --  Input Compare Match Flag F
      TCFF           : GTST_TCFF_Field := R7FA4M1AB.GPT321.Val_0;
      --  Overflow Flag
      TCFPO          : GTST_TCFPO_Field := R7FA4M1AB.GPT321.Val_0;
      --  Underflow Flag
      TCFPU          : GTST_TCFPU_Field := R7FA4M1AB.GPT321.Val_0;
      --  These bits are read as 0000000. The write value should be 0000000.
      Reserved       : GTST_Reserved_Field := 16#0#;
      --  Read-only. Count Direction Flag
      TUCF           : GTST_TUCF_Field := R7FA4M1AB.GPT321.Val_1;
   ...
   --  Disable
   type GTBER_BD_Field is
     (--  Buffer operation is enabled
     Val_0,
      --  Buffer operation is disabled
      Val_1)
   with Size => 2;
   for GTBER_BD_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type GTBER_PR_Field is
     ...
     Val_00,
      ...
      others_k)
   with Size => 2;
   for GTBER_PR_Field use (Val_00 => 0, Val_01 => 1, others_k => 3);
   ...
   type GTBER_CCRSWT_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTBER_CCRSWT_Field use (Val_0 => 0, Val_1 => 1);

   --  General PWM Timer Buffer Enable Register
   type GTBER_Register is record
      --  BD[1]: GTPR Buffer Operation Disable BD[0]: GTCCR Buffer Operation
      --  Disable
      BD             : GTBER_BD_Field := R7FA4M1AB.GPT321.Val_0;
      --  unspecified
      Reserved_2_15  : R7FA4M1AB.UInt14 := 16#0#;
      --  GTCCRA Buffer Operation
      CCRA           : GTBER_CCRA_Field := R7FA4M1AB.GPT321.Val_00;
      --  GTCCRB Buffer Operation
      CCRB           : GTBER_CCRB_Field := R7FA4M1AB.GPT321.Val_00;
      --  GTPR Buffer Operation
      PR             : GTBER_PR_Field := R7FA4M1AB.GPT321.Val_00;
      --  Write-only. GTCCRA and GTCCRB Forcible Buffer Operation This bit is
      --  read as 0.
      CCRSWT         : GTBER_CCRSWT_Field := R7FA4M1AB.GPT321.Val_0;
      --  unspecified
   ...
   type GTDTCR_TDE_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for GTDTCR_TDE_Field use (Val_0 => 0, Val_1 => 1);

   subtype GTDTCR_Reserved_Field is R7FA4M1AB.UInt3;
   --  GTDTCR_Reserved array element
   subtype GTDTCR_Reserved_Element is R7FA4M1AB.Bit;

   --  GTDTCR_Reserved array
   type GTDTCR_Reserved_Field_Array is
     array (1 .. 2) of GTDTCR_Reserved_Element
   with Component_Size => 1, Size => 2;

   --  Type definition for GTDTCR_Reserved
   type GTDTCR_Reserved_Field_1 (As_Array : Boolean := False) is record
      case As_Array is
         when False =>
            --  Reserved as a value
            Val : R7FA4M1AB.UInt2;
   ...
   for GTDTCR_Reserved_Field_1 use
     record
       Val at 0 range 0 .. 1;
       Arr at 0 range 0 .. 1;
     end record;
   ...
   subtype GTDTCR_Reserved_Field_3 is R7FA4M1AB.Bit;
   subtype GTDTCR_Reserved_Field_4 is R7FA4M1AB.UInt23;

   --  General PWM Timer Dead Time Control Register
   type GTDTCR_Register is record
      --  Negative-Phase Waveform Setting
      TDE        : GTDTCR_TDE_Field := R7FA4M1AB.GPT321.Val_0;
      --  These bits are read as 000. The write value should be 000.
   ...
   --  General PWM Timer 1 (32-bit)
   type GPT321_Peripheral is record
      --  General PWM Timer Write-Protection Register
   ...
   --  General PWM Timer 1 (32-bit)
   GPT321_Periph : aliased GPT321_Peripheral
   with Import, Address => GPT321_Base;

end R7FA4M1AB.GPT321;
