...
package R7FA4M1AB.SRAM is
   ...
   type PARIOAD_OAD_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for PARIOAD_OAD_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type SRAMPRCR_SRAMPRCR_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for SRAMPRCR_SRAMPRCR_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type SRAMPRCR_KW_Field is
     ...
     Val_1111000,
      ...
      others_k)
   with Size => 7;
   for SRAMPRCR_KW_Field use (Val_1111000 => 120, others_k => 127);
   ...
   type ECC2STS_ECC2ERR_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for ECC2STS_ECC2ERR_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type ECC1STSEN_E1STSEN_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for ECC1STSEN_E1STSEN_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type ECC1STS_ECC1ERR_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for ECC1STS_ECC1ERR_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type ECCPRCR_ECCPRCR_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for ECCPRCR_ECCPRCR_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type ECCPRCR_KW_Field is
     ...
     Val_1111000,
      ...
      others_k)
   with Size => 7;
   for ECCPRCR_KW_Field use (Val_1111000 => 120, others_k => 127);
   ...
   type ECCPRCR2_ECCPRCR2_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for ECCPRCR2_ECCPRCR2_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type ECCPRCR2_KW2_Field is
     ...
     Val_1111000,
      ...
      others_k)
   with Size => 7;
   for ECCPRCR2_KW2_Field use (Val_1111000 => 120, others_k => 127);
   ...
   type ECCETST_TSTBYP_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for ECCETST_TSTBYP_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type ECCOAD_OAD_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for ECCOAD_OAD_Field use (Val_0 => 0, Val_1 => 1);
