...
package R7FA4M1AB.DOC is
   ...
   type DOCR_OMS_Field is
     ...
     Val_00,
      ...
      Val_11)
   with Size => 2;
   for DOCR_OMS_Field use (Val_00 => 0, Val_01 => 1, Val_10 => 2, Val_11 => 3);
   ...
   type DOCR_DCSEL_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for DOCR_DCSEL_Field use (Val_0 => 0, Val_1 => 1);

   subtype DOCR_Reserved_Field is R7FA4M1AB.UInt2;
   subtype DOCR_DOPCF_Field is R7FA4M1AB.Bit;
   ...
   type DOCR_DOPCFCL_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for DOCR_DOPCFCL_Field use (Val_0 => 0, Val_1 => 1);

   subtype DOCR_Reserved_Field_1 is R7FA4M1AB.Bit;
