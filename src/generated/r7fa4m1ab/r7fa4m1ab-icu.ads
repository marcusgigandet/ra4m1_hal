...
package R7FA4M1AB.ICU is
   ...
   subtype IRQCR_Reserved_Field_1 is R7FA4M1AB.Bit;
   ...
   type IRQCR_FLTEN_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for IRQCR_FLTEN_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type NMICR_NMIMD_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for NMICR_NMIMD_Field use (Val_0 => 0, Val_1 => 1);
   ...
   subtype NMICR_Reserved_Field_1 is R7FA4M1AB.Bit;
   ...
   type NMICR_NFLTEN_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for NMICR_NFLTEN_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type NMIER_IWDTEN_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for NMIER_IWDTEN_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type NMIER_WDTEN_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for NMIER_WDTEN_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type NMIER_LVD1EN_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for NMIER_LVD1EN_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type NMIER_LVD2EN_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for NMIER_LVD2EN_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type NMIER_VBATTEN_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for NMIER_VBATTEN_Field use (Val_0 => 0, Val_1 => 1);

   subtype NMIER_Reserved_Field is R7FA4M1AB.Bit;
   ...
   type NMIER_OSTEN_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for NMIER_OSTEN_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type NMIER_NMIEN_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for NMIER_NMIEN_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type NMIER_RPEEN_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for NMIER_RPEEN_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type NMIER_RECCEN_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for NMIER_RECCEN_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type NMIER_BUSSEN_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for NMIER_BUSSEN_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type NMIER_BUSMEN_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for NMIER_BUSMEN_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type NMIER_SPEEN_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for NMIER_SPEEN_Field use (Val_0 => 0, Val_1 => 1);

   subtype NMIER_Reserved_Field_1 is R7FA4M1AB.UInt3;
   ...
   type NMICLR_IWDTCLR_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for NMICLR_IWDTCLR_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type NMICLR_WDTCLR_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for NMICLR_WDTCLR_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type NMICLR_LVD1CLR_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for NMICLR_LVD1CLR_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type NMICLR_LVD2CLR_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for NMICLR_LVD2CLR_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type NMICLR_VBATTCLR_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for NMICLR_VBATTCLR_Field use (Val_0 => 0, Val_1 => 1);

   subtype NMICLR_Reserved_Field is R7FA4M1AB.Bit;
   ...
   type NMICLR_OSTCLR_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for NMICLR_OSTCLR_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type NMICLR_NMICLR_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for NMICLR_NMICLR_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type NMICLR_RPECLR_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for NMICLR_RPECLR_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type NMICLR_RECCCLR_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for NMICLR_RECCCLR_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type NMICLR_BUSSCLR_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for NMICLR_BUSSCLR_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type NMICLR_BUSMCLR_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for NMICLR_BUSMCLR_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type NMICLR_SPECLR_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for NMICLR_SPECLR_Field use (Val_0 => 0, Val_1 => 1);

   subtype NMICLR_Reserved_Field_1 is R7FA4M1AB.UInt3;
   ...
   type NMISR_IWDTST_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for NMISR_IWDTST_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type NMISR_WDTST_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for NMISR_WDTST_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type NMISR_LVD1ST_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for NMISR_LVD1ST_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type NMISR_LVD2ST_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for NMISR_LVD2ST_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type NMISR_VBATTST_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for NMISR_VBATTST_Field use (Val_0 => 0, Val_1 => 1);

   subtype NMISR_Reserved_Field is R7FA4M1AB.Bit;
   ...
   type NMISR_OSTST_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for NMISR_OSTST_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type NMISR_NMIST_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for NMISR_NMIST_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type NMISR_RPEST_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for NMISR_RPEST_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type NMISR_RECCST_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for NMISR_RECCST_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type NMISR_BUSSST_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for NMISR_BUSSST_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type NMISR_BUSMST_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for NMISR_BUSMST_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type NMISR_SPEST_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for NMISR_SPEST_Field use (Val_0 => 0, Val_1 => 1);

   subtype NMISR_Reserved_Field_1 is R7FA4M1AB.UInt3;
   ...
   type WUPEN_IRQWUPEN0_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for WUPEN_IRQWUPEN0_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type WUPEN_IRQWUPEN1_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for WUPEN_IRQWUPEN1_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type WUPEN_IRQWUPEN2_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for WUPEN_IRQWUPEN2_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type WUPEN_IRQWUPEN3_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for WUPEN_IRQWUPEN3_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type WUPEN_IRQWUPEN4_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for WUPEN_IRQWUPEN4_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type WUPEN_IRQWUPEN5_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for WUPEN_IRQWUPEN5_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type WUPEN_IRQWUPEN6_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for WUPEN_IRQWUPEN6_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type WUPEN_IRQWUPEN7_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for WUPEN_IRQWUPEN7_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type WUPEN_IRQWUPEN8_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for WUPEN_IRQWUPEN8_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type WUPEN_IRQWUPEN9_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for WUPEN_IRQWUPEN9_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type WUPEN_IRQWUPEN10_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for WUPEN_IRQWUPEN10_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type WUPEN_IRQWUPEN11_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for WUPEN_IRQWUPEN11_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type WUPEN_IRQWUPEN12_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for WUPEN_IRQWUPEN12_Field use (Val_0 => 0, Val_1 => 1);

   subtype WUPEN_Reserved_Field is R7FA4M1AB.Bit;
   ...
   type WUPEN_IRQWUPEN14_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for WUPEN_IRQWUPEN14_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type WUPEN_IRQWUPEN15_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for WUPEN_IRQWUPEN15_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type WUPEN_IWDTWUPEN_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for WUPEN_IWDTWUPEN_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type WUPEN_KEYWUPEN_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for WUPEN_KEYWUPEN_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type WUPEN_LVD1WUPEN_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for WUPEN_LVD1WUPEN_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type WUPEN_LVD2WUPEN_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for WUPEN_LVD2WUPEN_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type WUPEN_VBATTWUPEN_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for WUPEN_VBATTWUPEN_Field use (Val_0 => 0, Val_1 => 1);

   subtype WUPEN_Reserved_Field_1 is R7FA4M1AB.UInt2;
   ...
   type WUPEN_ACMPLP0WUPEN_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for WUPEN_ACMPLP0WUPEN_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type WUPEN_RTCALMWUPEN_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for WUPEN_RTCALMWUPEN_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type WUPEN_RTCPRDWUPEN_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for WUPEN_RTCPRDWUPEN_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type WUPEN_USBFSWUPEN_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for WUPEN_USBFSWUPEN_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type WUPEN_AGT1UDWUPEN_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for WUPEN_AGT1UDWUPEN_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type WUPEN_AGT1CAWUPEN_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for WUPEN_AGT1CAWUPEN_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type WUPEN_AGT1CBWUPEN_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for WUPEN_AGT1CBWUPEN_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type WUPEN_IIC0WUPEN_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for WUPEN_IIC0WUPEN_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type DELSR0_DELS_Field is
     (--  Nothing is selected.
     Val_0x000,
      --  See Event Table
      others_k)
   with Size => 8;
   for DELSR0_DELS_Field use (Val_0x000 => 0, others_k => 255);
   ...
   --  linked .
   type IELSR_IELS_Field is
     (--  Nothing is selected
     Val_0x000,
      --  See Event Table
      others_k)
   with Size => 8;
   for IELSR_IELS_Field use (Val_0x000 => 0, others_k => 255);
   ...
   type IELSR_IR_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for IELSR_IR_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type IELSR_DTCE_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for IELSR_DTCE_Field use (Val_0 => 0, Val_1 => 1);
