...
package R7FA4M1AB.CRC is
   ...
   type CRCCR0_LMS_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for CRCCR0_LMS_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type CRCCR0_DORCLR_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for CRCCR0_DORCLR_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type CRCCR1_CRCSWR_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for CRCCR1_CRCSWR_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type CRCCR1_CRCSEN_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for CRCCR1_CRCSEN_Field use (Val_0 => 0, Val_1 => 1);
   ...
   --  CRC Calculator
   type CRC_Peripheral (Discriminent : CRC_Disc := View_CRCCR0) is record
   ...
   for CRC_Peripheral use
     record
       ...
       CRCDIR_BY at 16#4# range 0 .. 7;
       CRCDOR_BY at 16#8# range 0 .. 7;
       CRCDOR_HA at 16#8# range 0 .. 15;
     end record;
