...
package R7FA4M1AB.RTC is
   ...
   subtype R64CNT_F64HZ_Field is R7FA4M1AB.Bit;
   subtype R64CNT_F32HZ_Field is R7FA4M1AB.Bit;
   subtype R64CNT_F16HZ_Field is R7FA4M1AB.Bit;
   subtype R64CNT_F8HZ_Field is R7FA4M1AB.Bit;
   subtype R64CNT_F4HZ_Field is R7FA4M1AB.Bit;
   subtype R64CNT_F2HZ_Field is R7FA4M1AB.Bit;
   subtype R64CNT_F1HZ_Field is R7FA4M1AB.Bit;
   ...
   type RHRCNT_PM_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for RHRCNT_PM_Field use (Val_0 => 0, Val_1 => 1);
   ...
   subtype RMONCNT_MON10_Field is R7FA4M1AB.Bit;
   ...
   type RYRCNT_YR_Field (As_Array : Boolean := False) is record
      case As_Array is
         when False =>
            --  YR as a value
            Val : R7FA4M1AB.Byte;
   ...
   type RSECAR_ENB_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for RSECAR_ENB_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type RMINAR_ENB_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for RMINAR_ENB_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type RHRAR_PM_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for RHRAR_PM_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type RHRAR_ENB_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for RHRAR_ENB_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type RWKAR_ENB_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for RWKAR_ENB_Field use (Val_0 => 0, Val_1 => 1);
   ...
   subtype RDAYAR_Reserved_Field is R7FA4M1AB.Bit;
   ...
   type RDAYAR_ENB_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for RDAYAR_ENB_Field use (Val_0 => 0, Val_1 => 1);
   ...
   subtype RMONAR_MON10_Field is R7FA4M1AB.Bit;
   ...
   type RMONAR_ENB_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for RMONAR_ENB_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type RYRAR_YR_Field (As_Array : Boolean := False) is record
      case As_Array is
         when False =>
            --  YR as a value
            Val : R7FA4M1AB.Byte;
   ...
   for RYRAR_Register use
     record
       YR at 0 range 0 .. 7;
       Reserved at 0 range 8 .. 15;
     end record;

   subtype BCNT2AER_ENB_Field is R7FA4M1AB.Byte;
   subtype BCNT2AER_Reserved_Field is R7FA4M1AB.Byte;
   ...
   type RYRAREN_ENB_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for RYRAREN_ENB_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type RCR1_AIE_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for RCR1_AIE_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type RCR1_CIE_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for RCR1_CIE_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type RCR1_PIE_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for RCR1_PIE_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type RCR1_RTCOS_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for RCR1_RTCOS_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type RCR2_START_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for RCR2_START_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type RCR2_RESET_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for RCR2_RESET_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type RCR2_ADJ30_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for RCR2_ADJ30_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type RCR2_RTCOE_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for RCR2_RTCOE_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type RCR2_AADJE_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for RCR2_AADJE_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type RCR2_AADJP_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for RCR2_AADJP_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type RCR2_HR24_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for RCR2_HR24_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type RCR2_CNTMD_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for RCR2_CNTMD_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type RCR4_RCKSEL_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for RCR4_RCKSEL_Field use (Val_0 => 0, Val_1 => 1);
   ...
   for RCR4_Register use
     record
       RCKSEL at 0 range 0 .. 0;
       Reserved at 0 range 1 .. 7;
     end record;

   subtype RFRH_RFC16_Field is R7FA4M1AB.Bit;
   ...
   type RTCCR0_TCST_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for RTCCR0_TCST_Field use (Val_0 => 0, Val_1 => 1);

   subtype RTCCR_Reserved_Field is R7FA4M1AB.Bit;
   ...
   --  RTCCR_Reserved array element
   subtype RTCCR_Reserved_Element is R7FA4M1AB.Bit;

   --  RTCCR_Reserved array
   type RTCCR_Reserved_Field_Array is array (1 .. 2) of RTCCR_Reserved_Element
   with Component_Size => 1, Size => 2;

   --  Type definition for RTCCR_Reserved
   type RTCCR_Reserved_Field_1 (As_Array : Boolean := False) is record
      case As_Array is
         when False =>
            --  Reserved as a value
            Val : R7FA4M1AB.UInt2;
   ...
   for RTCCR_Reserved_Field_1 use
     record
       Val at 0 range 0 .. 1;
       Arr at 0 range 0 .. 1;
     end record;
   ...
   type RTCCR_Register is record
      ...
      --  This bit is read as 0. The write value should be 0.
      Reserved_1 : RTCCR_Reserved_Field_1 := (As_Array => False, Val => 16#0#);
   end record
   with
     Volatile_Full_Access,
     Object_Size => 8,
   ...
   subtype RSECCP_Reserved_Field is R7FA4M1AB.Bit;
   ...
   subtype RMINCP_Reserved_Field is R7FA4M1AB.Bit;
   ...
   type RHRCP0_PM_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for RHRCP0_PM_Field use (Val_0 => 0, Val_1 => 1);

   subtype RHRCP_Reserved_Field is R7FA4M1AB.Bit;
   ...
   subtype RMONCP_MON10_Field is R7FA4M1AB.Bit;
   ...
   --  Realtime Clock
   type RTC_Peripheral (Discriminent : RTC_Disc := View_R64CNT) is record
   ...
   for RTC_Peripheral use
     record
       ...
       BCNT0 at 16#2# range 0 .. 7;
       BCNT1 at 16#4# range 0 .. 7;
       BCNT2 at 16#6# range 0 .. 7;
       BCNT3 at 16#8# range 0 .. 7;
       BCNT0AR at 16#10# range 0 .. 7;
       BCNT1AR at 16#12# range 0 .. 7;
       BCNT2AR at 16#14# range 0 .. 7;
       BCNT3AR at 16#16# range 0 .. 7;
       BCNT0AER at 16#18# range 0 .. 7;
       BCNT1AER at 16#1A# range 0 .. 7;
       BCNT2AER at 16#1C# range 0 .. 15;
       BCNT3AER at 16#1E# range 0 .. 7;
       BCNT0CP0 at 16#52# range 0 .. 7;
       BCNT1CP0 at 16#54# range 0 .. 7;
       BCNT2CP0 at 16#56# range 0 .. 7;
       BCNT3CP0 at 16#5A# range 0 .. 7;
       BCNT0CP1 at 16#62# range 0 .. 7;
       BCNT1CP1 at 16#64# range 0 .. 7;
       BCNT2CP1 at 16#66# range 0 .. 7;
       BCNT3CP1 at 16#6A# range 0 .. 7;
       BCNT0CP2 at 16#72# range 0 .. 7;
       BCNT1CP2 at 16#74# range 0 .. 7;
       BCNT2CP2 at 16#76# range 0 .. 7;
       BCNT3CP2 at 16#7A# range 0 .. 7;
     end record;
