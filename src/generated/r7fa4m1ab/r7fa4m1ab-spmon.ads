...
package R7FA4M1AB.SPMON is
   ...
   type MSPMPUOAD_OAD_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for MSPMPUOAD_OAD_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type MSPMPUOAD_KEY_Field is
     ...
     Val_0xA5,
      ...
      others_k)
   with Size => 8;
   for MSPMPUOAD_KEY_Field use (Val_0xA5 => 165, others_k => 255);
   ...
   type MSPMPUCTL_ENABLE_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for MSPMPUCTL_ENABLE_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type MSPMPUCTL_ERROR_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for MSPMPUCTL_ERROR_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type MSPMPUPT_PROTECT_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for MSPMPUPT_PROTECT_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type MSPMPUPT_KEY_Field is
     ...
     Val_0xA5,
      ...
      others_k)
   with Size => 8;
   for MSPMPUPT_KEY_Field use (Val_0xA5 => 165, others_k => 255);
   ...
   type PSPMPUOAD_OAD_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for PSPMPUOAD_OAD_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type PSPMPUOAD_KEY_Field is
     ...
     Val_0xA5,
      ...
      others_k)
   with Size => 8;
   for PSPMPUOAD_KEY_Field use (Val_0xA5 => 165, others_k => 255);
   ...
   type PSPMPUCTL_ENABLE_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for PSPMPUCTL_ENABLE_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type PSPMPUCTL_ERROR_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for PSPMPUCTL_ERROR_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type PSPMPUPT_PROTECT_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for PSPMPUPT_PROTECT_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type PSPMPUPT_KEY_Field is
     ...
     Val_0xA5,
      ...
      others_k)
   with Size => 8;
   for PSPMPUPT_KEY_Field use (Val_0xA5 => 165, others_k => 255);
