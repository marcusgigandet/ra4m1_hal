...
package R7FA4M1AB.OPAMP is
   ...
   for AMPMC_AMPPC_Field use record
      Val at 0 range 0 .. 3;
      Arr at 0 range 0 .. 3;
   end record;
...
--  mode(AMPTRM30=1).
   ...
   for AMPTRM_Register use record
...
--  0.Operational amplifier 3: Operational amplifier An activation trigger 0
   ...
   for AMPTRS_Register use record
...
--  activation and A/D trigger mode: Wait for An activation is enabled.
   ...
   for AMPC_AMPE_Field use record
      Val at 0 range 0 .. 2;
      Arr at 0 range 0 .. 2;
   end record;
   ...
   for AMPMON_Register use record
