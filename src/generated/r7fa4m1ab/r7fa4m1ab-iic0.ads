...
--  enabled).
   ...
   type SARU0_FS_Field is
     (--  The 7-bit address format is selected.
      ...
      Val_1)
     with Size => 1;
   for SARU0_FS_Field use
     (Val_0 => 0,
      Val_1 => 1);

   --  SARU_SVA array
   type SARU_SVA_Field_Array is array (8 .. 9) of Boolean
   ...
   for ICWUR2_Register use record
   ...
   for IIC0_Peripheral use record
