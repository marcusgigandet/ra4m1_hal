...
--  enabled)
   ...
   for COMPMDR_Register use record
   ...
   for COMPFIR_Register use record
   ...
   type COMPOCR_C0OP_Field is
     (--  Non inverted
      ...
      Val_1)
     with Size => 1;
   for COMPOCR_C0OP_Field use
     (Val_0 => 0,
      Val_1 => 1);

   subtype COMPOCR_Reserved_Field is R7FA4M1AB.UInt2;
   ...
   type COMPOCR_Register is record
      ...
      Reserved_1 : COMPOCR_Reserved_Field := 16#0#;
      --  ACMPLP1 VCOUT Pin Output Enable
   ...
   for COMPOCR_Register use record
   ...
   for COMPSEL0_Register use record
   ...
   for COMPSEL1_Register use record
   ...
   for ACMPLP_Peripheral use record
