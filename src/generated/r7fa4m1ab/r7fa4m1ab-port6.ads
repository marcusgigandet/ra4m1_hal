...
package R7FA4M1AB.PORT6 is
   ...
   --  Port 6 Control Registers
   type PORT6_Peripheral (Discriminent : PORT6_Disc := View_PDR) is record
   ...
   --  Port 6 Control Registers
   PORT6_Periph : aliased PORT6_Peripheral
   with Import, Address => PORT6_Base;
