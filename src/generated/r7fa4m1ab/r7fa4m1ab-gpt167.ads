...
package R7FA4M1AB.GPT167 is
   ...
   type GTWP_Register is record
      --  Register Write Disable
      WP         : GTWP_WP_Field := R7FA4M1AB.GPT167.Val_0;
      ...
      PRKEY      : GTWP_PRKEY_Field := R7FA4M1AB.GPT167.others_k;
   ...
   type GTSTR_Register is record
      --  Channel 0 GTCNT Count Start Read data shows each channel's counter
      --  status (GTCR.CST bit). 0 means counter stop. 1 means counter running.
      CSTRT0   : GTSTR_CSTRT0_Field := R7FA4M1AB.GPT167.Val_0;
      --  Channel 1 GTCNT Count Start Read data shows each channel's counter
      --  status (GTCR.CST bit). 0 means counter stop. 1 means counter running.
      CSTRT1   : GTSTR_CSTRT1_Field := R7FA4M1AB.GPT167.Val_0;
      --  Channel 2 GTCNT Count Start Read data shows each channel's counter
      --  status (GTCR.CST bit). 0 means counter stop. 1 means counter running.
      CSTRT2   : GTSTR_CSTRT2_Field := R7FA4M1AB.GPT167.Val_0;
      --  Channel 3 GTCNT Count Start Read data shows each channel's counter
      --  status (GTCR.CST bit). 0 means counter stop. 1 means counter running.
      CSTRT3   : GTSTR_CSTRT3_Field := R7FA4M1AB.GPT167.Val_0;
      --  Channel 4 GTCNT Count Start Read data shows each channel's counter
      --  status (GTCR.CST bit). 0 means counter stop. 1 means counter running.
      CSTRT4   : GTSTR_CSTRT4_Field := R7FA4M1AB.GPT167.Val_0;
      --  Channel 5 GTCNT Count Start Read data shows each channel's counter
      --  status (GTCR.CST bit). 0 means counter stop. 1 means counter running.
      CSTRT5   : GTSTR_CSTRT5_Field := R7FA4M1AB.GPT167.Val_0;
      --  Channel 6 GTCNT Count Start Read data shows each channel's counter
      --  status (GTCR.CST bit). 0 means counter stop. 1 means counter running.
      CSTRT6   : GTSTR_CSTRT6_Field := R7FA4M1AB.GPT167.Val_0;
      --  Channel 7 GTCNT Count Start Read data shows each channel's counter
      --  status (GTCR.CST bit). 0 means counter stop. 1 means counter running.
      CSTRT7   : GTSTR_CSTRT7_Field := R7FA4M1AB.GPT167.Val_0;
   ...
   type GTCLR_Register is record
      ...
      CCLR0    : GTCLR_CCLR0_Field := R7FA4M1AB.GPT167.Val_0;
      --  Write-only. Channel 1 GTCNT Count Clear
      CCLR1    : GTCLR_CCLR1_Field := R7FA4M1AB.GPT167.Val_0;
      --  Write-only. Channel 2 GTCNT Count Clear
      CCLR2    : GTCLR_CCLR2_Field := R7FA4M1AB.GPT167.Val_0;
      --  Write-only. Channel 3 GTCNT Count Clear
      CCLR3    : GTCLR_CCLR3_Field := R7FA4M1AB.GPT167.Val_0;
      --  Write-only. Channel 4 GTCNT Count Clear
      CCLR4    : GTCLR_CCLR4_Field := R7FA4M1AB.GPT167.Val_0;
      --  Write-only. Channel 5 GTCNT Count Clear
      CCLR5    : GTCLR_CCLR5_Field := R7FA4M1AB.GPT167.Val_0;
      --  Write-only. Channel 6 GTCNT Count Clear
      CCLR6    : GTCLR_CCLR6_Field := R7FA4M1AB.GPT167.Val_0;
      --  Write-only. Channel 7 GTCNT Count Clear
      CCLR7    : GTCLR_CCLR7_Field := R7FA4M1AB.GPT167.Val_0;
   ...
   type GTSSR_Register is record
      --  GTETRGA Pin Rising Input Source Counter Start Enable
      SSGTRGAR   : GTSSR_SSGTRGAR_Field := R7FA4M1AB.GPT167.Val_0;
      --  GTETRGA Pin Falling Input Source Counter Start Enable
      SSGTRGAF   : GTSSR_SSGTRGAF_Field := R7FA4M1AB.GPT167.Val_0;
      --  GTETRGB Pin Rising Input Source Counter Start Enable
      SSGTRGBR   : GTSSR_SSGTRGBR_Field := R7FA4M1AB.GPT167.Val_0;
      --  GTETRGB Pin Falling Input Source Counter Start Enable
      SSGTRGBF   : GTSSR_SSGTRGBF_Field := R7FA4M1AB.GPT167.Val_0;
      --  These bits are read as 0000. The write value should be 0000.
      Reserved   : GTSSR_Reserved_Field := 16#0#;
      --  GTIOCA Pin Rising Input during GTIOCB Value Low Source Counter Start
      --  Enable
      SSCARBL    : GTSSR_SSCARBL_Field := R7FA4M1AB.GPT167.Val_0;
      --  GTIOCA Pin Rising Input during GTIOCB Value High Source Counter Start
      --  Enable
      SSCARBH    : GTSSR_SSCARBH_Field := R7FA4M1AB.GPT167.Val_0;
      --  GTIOCA Pin Falling Input during GTIOCB Value Low Source Counter Start
      --  Enable
      SSCAFBL    : GTSSR_SSCAFBL_Field := R7FA4M1AB.GPT167.Val_0;
      --  GTIOCA Pin Falling Input during GTIOCB Value High Source Counter
      --  Start Enable
      SSCAFBH    : GTSSR_SSCAFBH_Field := R7FA4M1AB.GPT167.Val_0;
      --  GTIOCB Pin Rising Input during GTIOCA Value Low Source Counter Start
      --  Enable
      SSCBRAL    : GTSSR_SSCBRAL_Field := R7FA4M1AB.GPT167.Val_0;
      --  GTIOCB Pin Rising Input during GTIOCA Value High Source Counter Start
      --  Enable
      SSCBRAH    : GTSSR_SSCBRAH_Field := R7FA4M1AB.GPT167.Val_0;
      --  GTIOCB Pin Falling Input during GTIOCA Value Low Source Counter Start
      --  Enable
      SSCBFAL    : GTSSR_SSCBFAL_Field := R7FA4M1AB.GPT167.Val_0;
      --  GTIOCB Pin Falling Input during GTIOCA Value High Source Counter
      --  Start Enable
      SSCBFAH    : GTSSR_SSCBFAH_Field := R7FA4M1AB.GPT167.Val_0;
      --  ELC_GPTA Event Source Counter Start Enable
      SSELCA     : GTSSR_SSELCA_Field := R7FA4M1AB.GPT167.Val_0;
      --  ELC_GPTB Event Source Counter Start Enable
      SSELCB     : GTSSR_SSELCB_Field := R7FA4M1AB.GPT167.Val_0;
      --  ELC_GPTC Event Source Counter Start Enable
      SSELCC     : GTSSR_SSELCC_Field := R7FA4M1AB.GPT167.Val_0;
      --  ELC_GPTD Event Source Counter Start Enable
      SSELCD     : GTSSR_SSELCD_Field := R7FA4M1AB.GPT167.Val_0;
      --  ELC_GPTE Event Source Counter Start Enable
      SSELCE     : GTSSR_SSELCE_Field := R7FA4M1AB.GPT167.Val_0;
      --  ELC_GPTF Event Source Counter Start Enable
      SSELCF     : GTSSR_SSELCF_Field := R7FA4M1AB.GPT167.Val_0;
      --  ELC_GPTG Event Source Counter Start Enable
      SSELCG     : GTSSR_SSELCG_Field := R7FA4M1AB.GPT167.Val_0;
      --  ELC_GPTH Event Source Counter Start Enable
      SSELCH     : GTSSR_SSELCH_Field := R7FA4M1AB.GPT167.Val_0;
      --  These bits are read as 0000000. The write value should be 0000000.
      Reserved_1 : GTSSR_Reserved_Field_1 := 16#0#;
      --  Software Source Counter Start Enable
      CSTRT      : GTSSR_CSTRT_Field := R7FA4M1AB.GPT167.Val_0;
   end record
   with
     Volatile_Full_Access,
     Object_Size => 32,
   ...
   type GTPSR_Register is record
      --  GTETRGA Pin Rising Input Source Counter Stop Enable
      PSGTRGAR   : GTPSR_PSGTRGAR_Field := R7FA4M1AB.GPT167.Val_0;
      --  GTETRGA Pin Falling Input Source Counter Stop Enable
      PSGTRGAF   : GTPSR_PSGTRGAF_Field := R7FA4M1AB.GPT167.Val_0;
      --  GTETRGB Pin Rising Input Source Counter Stop Enable
      PSGTRGBR   : GTPSR_PSGTRGBR_Field := R7FA4M1AB.GPT167.Val_0;
      --  GTETRGB Pin Falling Input Source Counter Stop Enable
      PSGTRGBF   : GTPSR_PSGTRGBF_Field := R7FA4M1AB.GPT167.Val_0;
      --  These bits are read as 0000. The write value should be 0000.
      Reserved   : GTPSR_Reserved_Field := 16#0#;
      --  GTIOCA Pin Rising Input during GTIOCB Value Low Source Counter Stop
      --  Enable
      PSCARBL    : GTPSR_PSCARBL_Field := R7FA4M1AB.GPT167.Val_0;
      --  GTIOCA Pin Rising Input during GTIOCB Value High Source Counter Stop
      --  Enable
      PSCARBH    : GTPSR_PSCARBH_Field := R7FA4M1AB.GPT167.Val_0;
      --  GTIOCA Pin Falling Input during GTIOCB Value Low Source Counter Stop
      --  Enable
      PSCAFBL    : GTPSR_PSCAFBL_Field := R7FA4M1AB.GPT167.Val_0;
      --  GTIOCA Pin Falling Input during GTIOCB Value High Source Counter Stop
      --  Enable
      PSCAFBH    : GTPSR_PSCAFBH_Field := R7FA4M1AB.GPT167.Val_0;
      --  GTIOCB Pin Rising Input during GTIOCA Value Low Source Counter Stop
      --  Enable
      PSCBRAL    : GTPSR_PSCBRAL_Field := R7FA4M1AB.GPT167.Val_0;
      --  GTIOCB Pin Rising Input during GTIOCA Value High Source Counter Stop
      --  Enable
      PSCBRAH    : GTPSR_PSCBRAH_Field := R7FA4M1AB.GPT167.Val_0;
      --  GTIOCB Pin Falling Input during GTIOCA Value Low Source Counter Stop
      --  Enable
      PSCBFAL    : GTPSR_PSCBFAL_Field := R7FA4M1AB.GPT167.Val_0;
      --  GTIOCB Pin Falling Input during GTIOCA Value High Source Counter Stop
      --  Enable
      PSCBFAH    : GTPSR_PSCBFAH_Field := R7FA4M1AB.GPT167.Val_0;
      --  ELC_GPTA Event Source Counter Stop Enable
      PSELCA     : GTPSR_PSELCA_Field := R7FA4M1AB.GPT167.Val_0;
      --  ELC_GPTB Event Source Counter Stop Enable
      PSELCB     : GTPSR_PSELCB_Field := R7FA4M1AB.GPT167.Val_0;
      --  ELC_GPTC Event Source Counter Stop Enable
      PSELCC     : GTPSR_PSELCC_Field := R7FA4M1AB.GPT167.Val_0;
      --  ELC_GPTD Event Source Counter Stop Enable
      PSELCD     : GTPSR_PSELCD_Field := R7FA4M1AB.GPT167.Val_0;
      --  ELC_GPTE Event Source Counter Stop Enable
      PSELCE     : GTPSR_PSELCE_Field := R7FA4M1AB.GPT167.Val_0;
      --  ELC_GPTF Event Source Counter Stop Enable
      PSELCF     : GTPSR_PSELCF_Field := R7FA4M1AB.GPT167.Val_0;
      --  ELC_GPTG Event Source Counter Stop Enable
      PSELCG     : GTPSR_PSELCG_Field := R7FA4M1AB.GPT167.Val_0;
      --  ELC_GPTH Event Source Counter Stop Enable
      PSELCH     : GTPSR_PSELCH_Field := R7FA4M1AB.GPT167.Val_0;
      --  These bits are read as 0000000. The write value should be 0000000.
      Reserved_1 : GTPSR_Reserved_Field_1 := 16#0#;
      --  Software Source Counter Stop Enable
      CSTOP      : GTPSR_CSTOP_Field := R7FA4M1AB.GPT167.Val_0;
   end record
   with
     Volatile_Full_Access,
     Object_Size => 32,
   ...
   type GTCSR_Register is record
      --  GTETRGA Pin Rising Input Source Counter Clear Enable
      CSGTRGAR   : GTCSR_CSGTRGAR_Field := R7FA4M1AB.GPT167.Val_0;
      --  GTETRGA Pin Falling Input Source Counter Clear Enable
      CSGTRGAF   : GTCSR_CSGTRGAF_Field := R7FA4M1AB.GPT167.Val_0;
      --  GTETRGB Pin Rising Input Source Counter Clear Enable
      CSGTRGBR   : GTCSR_CSGTRGBR_Field := R7FA4M1AB.GPT167.Val_0;
      --  GTETRGB Pin Falling Input Source Counter Clear Enable
      CSGTRGBF   : GTCSR_CSGTRGBF_Field := R7FA4M1AB.GPT167.Val_0;
      --  These bits are read as 0000. The write value should be 0000.
      Reserved   : GTCSR_Reserved_Field := 16#0#;
      --  GTIOCA Pin Rising Input during GTIOCB Value Low Source Counter Clear
      --  Enable
      CSCARBL    : GTCSR_CSCARBL_Field := R7FA4M1AB.GPT167.Val_0;
      --  GTIOCA Pin Rising Input during GTIOCB Value High Source Counter Clear
      --  Enable
      CSCARBH    : GTCSR_CSCARBH_Field := R7FA4M1AB.GPT167.Val_0;
      --  GTIOCA Pin Falling Input during GTIOCB Value Low Source Counter Clear
      --  Enable
      CSCAFBL    : GTCSR_CSCAFBL_Field := R7FA4M1AB.GPT167.Val_0;
      --  GTIOCA Pin Falling Input during GTIOCB Value High Source Counter
      --  Clear Enable
      CSCAFBH    : GTCSR_CSCAFBH_Field := R7FA4M1AB.GPT167.Val_0;
      --  GTIOCB Pin Rising Input during GTIOCA Value Low Source Counter Clear
      --  Enable
      CSCBRAL    : GTCSR_CSCBRAL_Field := R7FA4M1AB.GPT167.Val_0;
      --  GTIOCB Pin Rising Input during GTIOCA Value High Source Counter Clear
      --  Enable
      CSCBRAH    : GTCSR_CSCBRAH_Field := R7FA4M1AB.GPT167.Val_0;
      --  GTIOCB Pin Falling Input during GTIOCA Value Low Source Counter Clear
      --  Enable
      CSCBFAL    : GTCSR_CSCBFAL_Field := R7FA4M1AB.GPT167.Val_0;
      --  GTIOCB Pin Falling Input during GTIOCA Value High Source Counter
      --  Clear Enable
      CSCBFAH    : GTCSR_CSCBFAH_Field := R7FA4M1AB.GPT167.Val_0;
      --  ELC_GPTA Event Source Counter Clear Enable
      CSELCA     : GTCSR_CSELCA_Field := R7FA4M1AB.GPT167.Val_0;
      --  ELC_GPTB Event Source Counter Clear Enable
      CSELCB     : GTCSR_CSELCB_Field := R7FA4M1AB.GPT167.Val_0;
      --  ELC_GPTC Event Source Counter Clear Enable
      CSELCC     : GTCSR_CSELCC_Field := R7FA4M1AB.GPT167.Val_0;
      --  ELC_GPTD Event Source Counter Clear Enable
      CSELCD     : GTCSR_CSELCD_Field := R7FA4M1AB.GPT167.Val_0;
      --  ELC_GPTE Event Source Counter Clear Enable
      CSELCE     : GTCSR_CSELCE_Field := R7FA4M1AB.GPT167.Val_0;
      --  ELC_GPTF Event Source Counter Clear Enable
      CSELCF     : GTCSR_CSELCF_Field := R7FA4M1AB.GPT167.Val_0;
      --  ELC_GPTG Event Source Counter Clear Enable
      CSELCG     : GTCSR_CSELCG_Field := R7FA4M1AB.GPT167.Val_0;
      --  ELC_GPTH Event Source Counter Clear Enable
      CSELCH     : GTCSR_CSELCH_Field := R7FA4M1AB.GPT167.Val_0;
      --  These bits are read as 0000000. The write value should be 0000000.
      Reserved_1 : GTCSR_Reserved_Field_1 := 16#0#;
      --  Software Source Counter Clear Enable
      CCLR       : GTCSR_CCLR_Field := R7FA4M1AB.GPT167.Val_0;
   end record
   with
     Volatile_Full_Access,
     Object_Size => 32,
   ...
   type GTUPSR_Register is record
      --  GTETRGA Pin Rising Input Source Counter Count Up Enable
      USGTRGAR       : GTUPSR_USGTRGAR_Field := R7FA4M1AB.GPT167.Val_0;
      --  GTETRGA Pin Falling Input Source Counter Count Up Enable
      USGTRGAF       : GTUPSR_USGTRGAF_Field := R7FA4M1AB.GPT167.Val_0;
      --  GTETRGB Pin Rising Input Source Counter Count Up Enable
      USGTRGBR       : GTUPSR_USGTRGBR_Field := R7FA4M1AB.GPT167.Val_0;
      --  GTETRGB Pin Falling Input Source Counter Count Up Enable
      USGTRGBF       : GTUPSR_USGTRGBF_Field := R7FA4M1AB.GPT167.Val_0;
      --  unspecified
      Reserved_4_7   : R7FA4M1AB.UInt4 := 16#0#;
      --  GTIOCA Pin Rising Input during GTIOCB Value Low Source Counter Count
      --  Up Enable
      USCARBL        : GTUPSR_USCARBL_Field := R7FA4M1AB.GPT167.Val_0;
      --  GTIOCA Pin Rising Input during GTIOCB Value High Source Counter Count
      --  Up Enable
      USCARBH        : GTUPSR_USCARBH_Field := R7FA4M1AB.GPT167.Val_0;
      --  GTIOCA Pin Falling Input during GTIOCB Value Low Source Counter Count
      --  Up Enable
      USCAFBL        : GTUPSR_USCAFBL_Field := R7FA4M1AB.GPT167.Val_0;
      --  GTIOCA Pin Falling Input during GTIOCB Value High Source Counter
      --  Count Up Enable
      USCAFBH        : GTUPSR_USCAFBH_Field := R7FA4M1AB.GPT167.Val_0;
      --  GTIOCB Pin Rising Input during GTIOCA Value Low Source Counter Count
      --  Up Enable
      USCBRAL        : GTUPSR_USCBRAL_Field := R7FA4M1AB.GPT167.Val_0;
      --  GTIOCB Pin Rising Input during GTIOCA Value High Source Counter Count
      --  Up Enable
      USCBRAH        : GTUPSR_USCBRAH_Field := R7FA4M1AB.GPT167.Val_0;
      --  GTIOCB Pin Falling Input during GTIOCA Value Low Source Counter Count
      --  Up Enable
      USCBFAL        : GTUPSR_USCBFAL_Field := R7FA4M1AB.GPT167.Val_0;
      --  GTIOCB Pin Falling Input during GTIOCA Value High Source Counter
      --  Count Up Enable
      USCBFAH        : GTUPSR_USCBFAH_Field := R7FA4M1AB.GPT167.Val_0;
      --  ELC_GPTA Event Source Counter Count Up Enable
      USELCA         : GTUPSR_USELCA_Field := R7FA4M1AB.GPT167.Val_0;
      --  ELC_GPTB Event Source Counter Count Up Enable
      USELCB         : GTUPSR_USELCB_Field := R7FA4M1AB.GPT167.Val_0;
      --  ELC_GPTC Event Source Counter Count Up Enable
      USELCC         : GTUPSR_USELCC_Field := R7FA4M1AB.GPT167.Val_0;
      --  ELC_GPTD Event Source Counter Count Up Enable
      USELCD         : GTUPSR_USELCD_Field := R7FA4M1AB.GPT167.Val_0;
      --  ELC_GPTE Event Source Counter Count Up Enable
      USELCE         : GTUPSR_USELCE_Field := R7FA4M1AB.GPT167.Val_0;
      --  ELC_GPTF Event Source Counter Count Up Enable
      USELCF         : GTUPSR_USELCF_Field := R7FA4M1AB.GPT167.Val_0;
      --  ELC_GPTG Event Source Counter Count Up Enable
      USELCG         : GTUPSR_USELCG_Field := R7FA4M1AB.GPT167.Val_0;
      --  ELC_GPTH Event Source Counter Count Up Enable
      USELCH         : GTUPSR_USELCH_Field := R7FA4M1AB.GPT167.Val_0;
      --  unspecified
   ...
   type GTDNSR_Register is record
      --  GTETRGA Pin Rising Input Source Counter Count Down Enable
      DSGTRGAR       : GTDNSR_DSGTRGAR_Field := R7FA4M1AB.GPT167.Val_0;
      --  GTETRGA Pin Falling Input Source Counter Count Down Enable
      DSGTRGAF       : GTDNSR_DSGTRGAF_Field := R7FA4M1AB.GPT167.Val_0;
      --  GTETRGB Pin Rising Input Source Counter Count Down Enable
      DSGTRGBR       : GTDNSR_DSGTRGBR_Field := R7FA4M1AB.GPT167.Val_0;
      --  GTETRGB Pin Falling Input Source Counter Count Down Enable
      DSGTRGBF       : GTDNSR_DSGTRGBF_Field := R7FA4M1AB.GPT167.Val_0;
      --  unspecified
      Reserved_4_7   : R7FA4M1AB.UInt4 := 16#0#;
      --  GTIOCA Pin Rising Input during GTIOCB Value Low Source Counter Count
      --  Down Enable
      DSCARBL        : GTDNSR_DSCARBL_Field := R7FA4M1AB.GPT167.Val_0;
      --  GTIOCA Pin Rising Input during GTIOCB Value High Source Counter Count
      --  Down Enable
      DSCARBH        : GTDNSR_DSCARBH_Field := R7FA4M1AB.GPT167.Val_0;
      --  GTIOCA Pin Falling Input during GTIOCB Value Low Source Counter Count
      --  Down Enable
      DSCAFBL        : GTDNSR_DSCAFBL_Field := R7FA4M1AB.GPT167.Val_0;
      --  GTIOCA Pin Falling Input during GTIOCB Value High Source Counter
      --  Count Down Enable
      DSCAFBH        : GTDNSR_DSCAFBH_Field := R7FA4M1AB.GPT167.Val_0;
      --  GTIOCB Pin Rising Input during GTIOCA Value Low Source Counter Count
      --  Down Enable
      DSCBRAL        : GTDNSR_DSCBRAL_Field := R7FA4M1AB.GPT167.Val_0;
      --  GTIOCB Pin Rising Input during GTIOCA Value High Source Counter Count
      --  Down Enable
      DSCBRAH        : GTDNSR_DSCBRAH_Field := R7FA4M1AB.GPT167.Val_0;
      --  GTIOCB Pin Falling Input during GTIOCA Value Low Source Counter Count
      --  Down Enable
      DSCBFAL        : GTDNSR_DSCBFAL_Field := R7FA4M1AB.GPT167.Val_0;
      --  GTIOCB Pin Falling Input during GTIOCA Value High Source Counter
      --  Count Down Enable
      DSCBFAH        : GTDNSR_DSCBFAH_Field := R7FA4M1AB.GPT167.Val_0;
      --  ELC_GPTA Event Source Counter Count Down Enable
      DSELCA         : GTDNSR_DSELCA_Field := R7FA4M1AB.GPT167.Val_0;
      --  ELC_GPTB Event Source Counter Count Down Enable
      DSELCB         : GTDNSR_DSELCB_Field := R7FA4M1AB.GPT167.Val_0;
      --  ELC_GPTC Event Source Counter Count Down Enable
      DSELCC         : GTDNSR_DSELCC_Field := R7FA4M1AB.GPT167.Val_0;
      --  ELC_GPTD Event Source Counter Count Down Enable
      DSELCD         : GTDNSR_DSELCD_Field := R7FA4M1AB.GPT167.Val_0;
      --  ELC_GPTE Event Source Counter Count Down Enable
      DSELCE         : GTDNSR_DSELCE_Field := R7FA4M1AB.GPT167.Val_0;
      --  ELC_GPTF Event Source Counter Count Down Enable
      DSELCF         : GTDNSR_DSELCF_Field := R7FA4M1AB.GPT167.Val_0;
      --  ELC_GPTG Event Source Counter Count Down Enable
      DSELCG         : GTDNSR_DSELCG_Field := R7FA4M1AB.GPT167.Val_0;
      --  ELC_GPTH Event Source Counter Count Down Enable
      DSELCH         : GTDNSR_DSELCH_Field := R7FA4M1AB.GPT167.Val_0;
      --  unspecified
      Reserved_24_31 : R7FA4M1AB.Byte := 16#0#;
   end record
   with
   ...
   type GTICASR_Register is record
      --  GTETRGA Pin Rising Input Source GTCCRA Input Capture Enable
      ASGTRGAR       : GTICASR_ASGTRGAR_Field := R7FA4M1AB.GPT167.Val_0;
      --  GTETRGA Pin Falling Input Source GTCCRA Input Capture Enable
      ASGTRGAF       : GTICASR_ASGTRGAF_Field := R7FA4M1AB.GPT167.Val_0;
      --  GTETRGB Pin Rising Input Source GTCCRA Input Capture Enable
      ASGTRGBR       : GTICASR_ASGTRGBR_Field := R7FA4M1AB.GPT167.Val_0;
      --  GTETRGB Pin Falling Input Source GTCCRA Input Capture Enable
      ASGTRGBF       : GTICASR_ASGTRGBF_Field := R7FA4M1AB.GPT167.Val_0;
      --  unspecified
      Reserved_4_7   : R7FA4M1AB.UInt4 := 16#0#;
      --  GTIOCA Pin Rising Input during GTIOCB Value Low Source GTCCRA Input
      --  Capture Enable
      ASCARBL        : GTICASR_ASCARBL_Field := R7FA4M1AB.GPT167.Val_0;
      --  GTIOCA Pin Rising Input during GTIOCB Value High Source GTCCRA Input
      --  Capture Enable
      ASCARBH        : GTICASR_ASCARBH_Field := R7FA4M1AB.GPT167.Val_0;
      --  GTIOCA Pin Falling Input during GTIOCB Value Low Source GTCCRA Input
      --  Capture Enable
      ASCAFBL        : GTICASR_ASCAFBL_Field := R7FA4M1AB.GPT167.Val_0;
      --  GTIOCA Pin Falling Input during GTIOCB Value High Source GTCCRA Input
      --  Capture Enable
      ASCAFBH        : GTICASR_ASCAFBH_Field := R7FA4M1AB.GPT167.Val_0;
      --  GTIOCB Pin Rising Input during GTIOCA Value Low Source GTCCRA Input
      --  Capture Enable
      ASCBRAL        : GTICASR_ASCBRAL_Field := R7FA4M1AB.GPT167.Val_0;
      --  GTIOCB Pin Rising Input during GTIOCA Value High Source GTCCRA Input
      --  Capture Enable
      ASCBRAH        : GTICASR_ASCBRAH_Field := R7FA4M1AB.GPT167.Val_0;
      --  GTIOCB Pin Falling Input during GTIOCA Value Low Source GTCCRA Input
      --  Capture Enable
      ASCBFAL        : GTICASR_ASCBFAL_Field := R7FA4M1AB.GPT167.Val_0;
      --  GTIOCB Pin Falling Input during GTIOCA Value High Source GTCCRA Input
      --  Capture Enable
      ASCBFAH        : GTICASR_ASCBFAH_Field := R7FA4M1AB.GPT167.Val_0;
      --  ELC_GPTA Event Source GTCCRA Input Capture Enable
      ASELCA         : GTICASR_ASELCA_Field := R7FA4M1AB.GPT167.Val_0;
      --  ELC_GPTB Event Source GTCCRA Input Capture Enable
      ASELCB         : GTICASR_ASELCB_Field := R7FA4M1AB.GPT167.Val_0;
      --  ELC_GPTC Event Source GTCCRA Input Capture Enable
      ASELCC         : GTICASR_ASELCC_Field := R7FA4M1AB.GPT167.Val_0;
      --  ELC_GPTD Event Source GTCCRA Input Capture Enable
      ASELCD         : GTICASR_ASELCD_Field := R7FA4M1AB.GPT167.Val_0;
      --  ELC_GPTE Event Source GTCCRA Input Capture Enable
      ASELCE         : GTICASR_ASELCE_Field := R7FA4M1AB.GPT167.Val_0;
      --  ELC_GPTF Event Source GTCCRA Input Capture Enable
      ASELCF         : GTICASR_ASELCF_Field := R7FA4M1AB.GPT167.Val_0;
      --  ELC_GPTG Event Source GTCCRA Input Capture Enable
      ASELCG         : GTICASR_ASELCG_Field := R7FA4M1AB.GPT167.Val_0;
      --  ELC_GPTH Event Source GTCCRA Input Capture Enable
      ASELCH         : GTICASR_ASELCH_Field := R7FA4M1AB.GPT167.Val_0;
      --  unspecified
      Reserved_24_31 : R7FA4M1AB.Byte := 16#0#;
   end record
   with
   ...
   type GTICBSR_Register is record
      --  GTETRGA Pin Rising Input Source GTCCRB Input Capture Enable
      BSGTRGAR       : GTICBSR_BSGTRGAR_Field := R7FA4M1AB.GPT167.Val_0;
      --  GTETRGA Pin Falling Input Source GTCCRB Input Capture Enable
      BSGTRGAF       : GTICBSR_BSGTRGAF_Field := R7FA4M1AB.GPT167.Val_0;
      --  GTETRGB Pin Rising Input Source GTCCRB Input Capture Enable
      BSGTRGBR       : GTICBSR_BSGTRGBR_Field := R7FA4M1AB.GPT167.Val_0;
      --  GTETRGB Pin Falling Input Source GTCCRB Input Capture Enable
      BSGTRGBF       : GTICBSR_BSGTRGBF_Field := R7FA4M1AB.GPT167.Val_0;
      --  unspecified
      Reserved_4_7   : R7FA4M1AB.UInt4 := 16#0#;
      --  GTIOCA Pin Rising Input during GTIOCB Value Low Source GTCCRB Input
      --  Capture Enable
      BSCARBL        : GTICBSR_BSCARBL_Field := R7FA4M1AB.GPT167.Val_0;
      --  GTIOCA Pin Rising Input during GTIOCB Value High Source GTCCRB Input
      --  Capture Enable
      BSCARBH        : GTICBSR_BSCARBH_Field := R7FA4M1AB.GPT167.Val_0;
      --  GTIOCA Pin Falling Input during GTIOCB Value Low Source GTCCRB Input
      --  Capture Enable
      BSCAFBL        : GTICBSR_BSCAFBL_Field := R7FA4M1AB.GPT167.Val_0;
      --  GTIOCA Pin Falling Input during GTIOCB Value High Source GTCCRB Input
      --  Capture Enable
      BSCAFBH        : GTICBSR_BSCAFBH_Field := R7FA4M1AB.GPT167.Val_0;
      --  GTIOCB Pin Rising Input during GTIOCA Value Low Source GTCCRB Input
      --  Capture Enable
      BSCBRAL        : GTICBSR_BSCBRAL_Field := R7FA4M1AB.GPT167.Val_0;
      --  GTIOCB Pin Rising Input during GTIOCA Value High Source GTCCRB Input
      --  Capture Enable
      BSCBRAH        : GTICBSR_BSCBRAH_Field := R7FA4M1AB.GPT167.Val_0;
      --  GTIOCB Pin Falling Input during GTIOCA Value Low Source GTCCRB Input
      --  Capture Enable
      BSCBFAL        : GTICBSR_BSCBFAL_Field := R7FA4M1AB.GPT167.Val_0;
      --  GTIOCB Pin Falling Input during GTIOCA Value High Source GTCCRB Input
      --  Capture Enable
      BSCBFAH        : GTICBSR_BSCBFAH_Field := R7FA4M1AB.GPT167.Val_0;
      --  ELC_GPTA Event Source GTCCRB Input Capture Enable
      BSELCA         : GTICBSR_BSELCA_Field := R7FA4M1AB.GPT167.Val_0;
      --  ELC_GPTB Event Source GTCCRB Input Capture Enable
      BSELCB         : GTICBSR_BSELCB_Field := R7FA4M1AB.GPT167.Val_0;
      --  ELC_GPTC Event Source GTCCRB Input Capture Enable
      BSELCC         : GTICBSR_BSELCC_Field := R7FA4M1AB.GPT167.Val_0;
      --  ELC_GPTD Event Source GTCCRB Input Capture Enable
      BSELCD         : GTICBSR_BSELCD_Field := R7FA4M1AB.GPT167.Val_0;
      --  ELC_GPTE Event Source GTCCRB Input Capture Enable
      BSELCE         : GTICBSR_BSELCE_Field := R7FA4M1AB.GPT167.Val_0;
      --  ELC_GPTF Event Source GTCCRB Input Capture Enable
      BSELCF         : GTICBSR_BSELCF_Field := R7FA4M1AB.GPT167.Val_0;
      --  ELC_GPTG Event Source GTCCRB Input Capture Enable
      BSELCG         : GTICBSR_BSELCG_Field := R7FA4M1AB.GPT167.Val_0;
      --  ELC_GPTH Event Source GTCCRB Input Capture Enable
      BSELCH         : GTICBSR_BSELCH_Field := R7FA4M1AB.GPT167.Val_0;
      --  unspecified
      Reserved_24_31 : R7FA4M1AB.Byte := 16#0#;
   end record
   with
   ...
   type GTUDDTYC_Register is record
      --  Count Direction Setting
      UD             : GTUDDTYC_UD_Field := R7FA4M1AB.GPT167.Val_1;
      --  Forcible Count Direction Setting
      UDF            : GTUDDTYC_UDF_Field := R7FA4M1AB.GPT167.Val_0;
      --  unspecified
      Reserved_2_15  : R7FA4M1AB.UInt14 := 16#0#;
      --  GTIOCA Output Duty Setting
      OADTY          : GTUDDTYC_OADTY_Field := R7FA4M1AB.GPT167.Val_00;
      --  Forcible GTIOCA Output Duty Setting
      OADTYF         : GTUDDTYC_OADTYF_Field := R7FA4M1AB.GPT167.Val_0;
      --  GTIOCA Output Value Selecting after Releasing 0 percent/100 percent
      --  Duty Setting
      OADTYR         : GTUDDTYC_OADTYR_Field := R7FA4M1AB.GPT167.Val_0;
      --  These bits are read as 0000. The write value should be 0000.
      Reserved       : GTUDDTYC_Reserved_Field := 16#0#;
      --  GTIOCB Output Duty Setting
      OBDTY          : GTUDDTYC_OBDTY_Field := R7FA4M1AB.GPT167.Val_00;
      --  Forcible GTIOCB Output Duty Setting
      OBDTYF         : GTUDDTYC_OBDTYF_Field := R7FA4M1AB.GPT167.Val_0;
      --  GTIOCB Output Value Selecting after Releasing 0 percent/100 percent
      --  Duty Setting
      OBDTYR         : GTUDDTYC_OBDTYR_Field := R7FA4M1AB.GPT167.Val_0;
      --  unspecified
   ...
   type GTIOR_Register is record
      --  GTIOCA Pin Function Select
      GTIOA      : GTIOR_GTIOA_Field := R7FA4M1AB.GPT167.Val_00000;
      --  This bit is read as 0. The write value should be 0.
      Reserved   : GTIOR_Reserved_Field := 16#0#;
      --  GTIOCA Pin Output Value Setting at the Count Stop
      OADFLT     : GTIOR_OADFLT_Field := R7FA4M1AB.GPT167.Val_0;
      --  GTIOCA Pin Output Setting at the Start/Stop Count
      OAHLD      : GTIOR_OAHLD_Field := R7FA4M1AB.GPT167.Val_0;
      --  GTIOCA Pin Output Enable
      OAE        : GTIOR_OAE_Field := R7FA4M1AB.GPT167.Val_0;
      --  GTIOCA Pin Disable Value Setting
      OADF       : GTIOR_OADF_Field := R7FA4M1AB.GPT167.Val_00;
      --  These bits are read as 00. The write value should be 00.
      Reserved_1 : GTIOR_Reserved_Field_1 := 16#0#;
      --  Noise Filter A Enable
      NFAEN      : GTIOR_NFAEN_Field := R7FA4M1AB.GPT167.Val_0;
      --  Noise Filter A Sampling Clock Select
      NFCSA      : GTIOR_NFCSA_Field := R7FA4M1AB.GPT167.Val_00;
      --  GTIOCB Pin Function Select
      GTIOB      : GTIOR_GTIOB_Field := R7FA4M1AB.GPT167.Val_00000;
      --  This bit is read as 0. The write value should be 0.
      Reserved_2 : GTIOR_Reserved_Field := 16#0#;
      --  GTIOCB Pin Output Value Setting at the Count Stop
      OBDFLT     : GTIOR_OBDFLT_Field := R7FA4M1AB.GPT167.Val_0;
      --  GTIOCB Pin Output Setting at the Start/Stop Count
      OBHLD      : GTIOR_OBHLD_Field := R7FA4M1AB.GPT167.Val_0;
      --  GTIOCB Pin Output Enable
      OBE        : GTIOR_OBE_Field := R7FA4M1AB.GPT167.Val_0;
      --  GTIOCB Pin Disable Value Setting
      OBDF       : GTIOR_OBDF_Field := R7FA4M1AB.GPT167.Val_00;
      --  These bits are read as 00. The write value should be 00.
      Reserved_3 : GTIOR_Reserved_Field_1 := 16#0#;
      --  Noise Filter B Enable
      NFBEN      : GTIOR_NFBEN_Field := R7FA4M1AB.GPT167.Val_0;
      --  Noise Filter B Sampling Clock Select
      NFCSB      : GTIOR_NFCSB_Field := R7FA4M1AB.GPT167.Val_00;
   end record
   with
     Volatile_Full_Access,
     Object_Size => 32,
   ...
   type GTINTAD_Register is record
      ...
      --  Output Disable Source Select
      GRP            : GTINTAD_GRP_Field := R7FA4M1AB.GPT167.Val_00;
      --  These bits are read as 000. The write value should be 000.
      Reserved_1     : GTINTAD_Reserved_Field_1 := 16#0#;
      --  Same Time Output Level High Disable Request Enable
      GRPABH         : GTINTAD_GRPABH_Field := R7FA4M1AB.GPT167.Val_0;
      --  Same Time Output Level Low Disable Request Enable
      GRPABL         : GTINTAD_GRPABL_Field := R7FA4M1AB.GPT167.Val_0;
      --  unspecified
   ...
   type GTST_Register is record
      --  Input Capture/Compare Match Flag A
      TCFA           : GTST_TCFA_Field := R7FA4M1AB.GPT167.Val_0;
      --  Input Capture/Compare Match Flag B
      TCFB           : GTST_TCFB_Field := R7FA4M1AB.GPT167.Val_0;
      --  Input Compare Match Flag C
      TCFC           : GTST_TCFC_Field := R7FA4M1AB.GPT167.Val_0;
      --  Input Compare Match Flag D
      TCFD           : GTST_TCFD_Field := R7FA4M1AB.GPT167.Val_0;
      --  Input Compare Match Flag E
      TCFE           : GTST_TCFE_Field := R7FA4M1AB.GPT167.Val_0;
      --  Input Compare Match Flag F
      TCFF           : GTST_TCFF_Field := R7FA4M1AB.GPT167.Val_0;
      --  Overflow Flag
      TCFPO          : GTST_TCFPO_Field := R7FA4M1AB.GPT167.Val_0;
      --  Underflow Flag
      TCFPU          : GTST_TCFPU_Field := R7FA4M1AB.GPT167.Val_0;
      --  These bits are read as 0000000. The write value should be 0000000.
      Reserved       : GTST_Reserved_Field := 16#0#;
      --  Read-only. Count Direction Flag
      TUCF           : GTST_TUCF_Field := R7FA4M1AB.GPT167.Val_1;
   ...
   type GTBER_Register is record
      --  BD[1]: GTPR Buffer Operation Disable BD[0]: GTCCR Buffer Operation
      --  Disable
      BD             : GTBER_BD_Field := R7FA4M1AB.GPT167.Val_0;
      --  unspecified
      Reserved_2_15  : R7FA4M1AB.UInt14 := 16#0#;
      --  GTCCRA Buffer Operation
      CCRA           : GTBER_CCRA_Field := R7FA4M1AB.GPT167.Val_00;
      --  GTCCRB Buffer Operation
      CCRB           : GTBER_CCRB_Field := R7FA4M1AB.GPT167.Val_00;
      --  GTPR Buffer Operation
      PR             : GTBER_PR_Field := R7FA4M1AB.GPT167.Val_00;
      --  Write-only. GTCCRA and GTCCRB Forcible Buffer Operation This bit is
      --  read as 0.
      CCRSWT         : GTBER_CCRSWT_Field := R7FA4M1AB.GPT167.Val_0;
      --  unspecified
   ...
   type GTDTCR_Register is record
      --  Negative-Phase Waveform Setting
      TDE        : GTDTCR_TDE_Field := R7FA4M1AB.GPT167.Val_0;
      --  These bits are read as 000. The write value should be 000.
   ...
   --  General PWM Timer 7 (16-bit)
   type GPT167_Peripheral is record
      --  General PWM Timer Write-Protection Register
   ...
   --  General PWM Timer 7 (16-bit)
   GPT167_Periph : aliased GPT167_Peripheral
   with Import, Address => GPT167_Base;

end R7FA4M1AB.GPT167;
