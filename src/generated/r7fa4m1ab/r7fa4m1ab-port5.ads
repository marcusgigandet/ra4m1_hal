...
package R7FA4M1AB.PORT5 is
   ...
   --  Port 5 Control Registers
   type PORT5_Peripheral (Discriminent : PORT5_Disc := View_PDR) is record
   ...
   --  Port 5 Control Registers
   PORT5_Periph : aliased PORT5_Peripheral
   with Import, Address => PORT5_Base;
