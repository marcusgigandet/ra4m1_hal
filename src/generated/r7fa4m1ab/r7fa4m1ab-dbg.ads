...
package R7FA4M1AB.DBG is
   ...
   type DBGSTR_CDBGPWRUPREQ_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for DBGSTR_CDBGPWRUPREQ_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type DBGSTR_CDBGPWRUPACK_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for DBGSTR_CDBGPWRUPACK_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type DBGSTOPCR_DBGSTOP_IWDT_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for DBGSTOPCR_DBGSTOP_IWDT_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type DBGSTOPCR_DBGSTOP_WDT_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for DBGSTOPCR_DBGSTOP_WDT_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type DBGSTOPCR_DBGSTOP_RPER_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for DBGSTOPCR_DBGSTOP_RPER_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type DBGSTOPCR_DBGSTOP_RECCR_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for DBGSTOPCR_DBGSTOP_RECCR_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type TRACECTR_ENETBFULL_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for TRACECTR_ENETBFULL_Field use (Val_0 => 0, Val_1 => 1);
