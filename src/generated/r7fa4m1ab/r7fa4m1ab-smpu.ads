...
--  0xA5.
   ...
   for SMPUCTL_Register use record
      OAD      at 0 range 0 .. 0;
   ...
   for SMPUMBIU_Register use record
   ...
   for SMPUFBIU_Register use record
   ...
   type SMPUSRAM0_RPGRPA_Field is
     (--  Master group A read of memory protection disabled.
      ...
      Val_1)
     with Size => 1;
   for SMPUSRAM0_RPGRPA_Field use
     (Val_0 => 0,
      Val_1 => 1);
   ...
   type SMPUSRAM0_WPGRPA_Field is
     (--  Master group A write of memory protection disabled.
      ...
      Val_1)
     with Size => 1;
   for SMPUSRAM0_WPGRPA_Field use
     (Val_0 => 0,
      Val_1 => 1);
   ...
   for SMPUSRAM0_Register use record
      RPCPU    at 0 range 0 .. 0;
      WPCPU    at 0 range 1 .. 1;
      RPGRPA   at 0 range 2 .. 2;
      WPGRPA   at 0 range 3 .. 3;
   ...
   type SMPUPBIU0_RPGRPA_Field is
     (--  Master group A read of memory protection disabled.
      ...
      Val_1)
     with Size => 1;
   for SMPUPBIU0_RPGRPA_Field use
     (Val_0 => 0,
      Val_1 => 1);
   ...
   type SMPUPBIU0_WPGRPA_Field is
     (--  Master group A write of memory protection disabled.
      ...
      Val_1)
     with Size => 1;
   for SMPUPBIU0_WPGRPA_Field use
     (Val_0 => 0,
      Val_1 => 1);
   ...
   for SMPUPBIU_Register use record
      RPCPU    at 0 range 0 .. 0;
      WPCPU    at 0 range 1 .. 1;
      RPGRPA   at 0 range 2 .. 2;
      WPGRPA   at 0 range 3 .. 3;
   ...
   for SMPU_Peripheral use record
