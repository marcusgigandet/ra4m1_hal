...
package R7FA4M1AB.BUS is
   ...
   type BUSSCNTFLI_Register is record
      ...
      ARBMET     : BUSSCNTFLI_ARBMET_Field := 16#0#;
   ...
   for BUSSCNTFLI_Register use record
   ...
   subtype BUSSCNT_ARBMET_Field is R7FA4M1AB.UInt2;
   ...
   type BUSSCNT_Register is record
      ...
      --  Arbitration Method Specify the priority between groups
      ARBMET     : BUSSCNT_ARBMET_Field := 16#0#;
      --  These bits are read as 0000000000. The write value should be
      --  0000000000.
   ...
   for BUSSCNT_Register use record
      Reserved   at 0 range 0 .. 3;
      ARBMET     at 0 range 4 .. 5;
      Reserved_1 at 0 range 6 .. 15;
   end record;
   ...
   subtype BUSSCNTP6B_ARBMET_Field is R7FA4M1AB.UInt2;
   ...
   type BUSSCNTP6B_Register is record
      ...
      --  Arbitration Method Specify the priority between groups
      ARBMET     : BUSSCNTP6B_ARBMET_Field := 16#0#;
      --  These bits are read as 0000000000. The write value should be
      --  0000000000.
   ...
   for BUSSCNTP6B_Register use record
      Reserved   at 0 range 0 .. 3;
      ARBMET     at 0 range 4 .. 5;
      Reserved_1 at 0 range 6 .. 15;
   end record;
   ...
   subtype BUSSCNTFBU_ARBMET_Field is R7FA4M1AB.UInt2;
   ...
   type BUSSCNTFBU_Register is record
      ...
      --  Arbitration Method Specify the priority between groups
      ARBMET     : BUSSCNTFBU_ARBMET_Field := 16#0#;
      --  These bits are read as 0000000000. The write value should be
      --  0000000000.
   ...
   for BUSSCNTFBU_Register use record
      Reserved   at 0 range 0 .. 3;
      ARBMET     at 0 range 4 .. 5;
      Reserved_1 at 0 range 6 .. 15;
   end record;
   ...
   type BUSERRSTAT0_ACCSTAT_Field is
     (--  Read access
      ...
      Val_1)
     with Size => 1;
   for BUSERRSTAT0_ACCSTAT_Field use
     (Val_0 => 0,
      Val_1 => 1);
   ...
   type BUSERRSTAT0_ERRSTAT_Field is
     (--  No bus error occurred
      ...
      Val_1)
     with Size => 1;
   for BUSERRSTAT0_ERRSTAT_Field use
     (Val_0 => 0,
      Val_1 => 1);
   ...
   for BUSERRSTAT_Register use record
