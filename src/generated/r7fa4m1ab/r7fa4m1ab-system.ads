...
package R7FA4M1AB.SYSTEM is
   ...
   for MSTPCRA_Register use record
   ...
   subtype SCKDIVCR_Reserved_Field is R7FA4M1AB.UInt2;
   subtype SCKDIVCR_Reserved_Field_1 is R7FA4M1AB.UInt5;
   ...
   type SCKDIVCR_Register is record
      ...
      Reserved_4 : SCKDIVCR_Reserved_Field := 16#0#;
      --  This bit is read as 1. The write value should be 1.
      Reserved_5 : Boolean := True;
      --  These bits are read as 00000. The write value should be 00000.
      Reserved_6 : SCKDIVCR_Reserved_Field_1 := 16#0#;
      --  System Clock (ICLK) Select
   ...
   for SCKDIVCR_Register use record
      PCKD       at 0 range 0 .. 2;
   ...
   for SCKSCR_Register use record
   ...
   for PLLCCR2_Register use record
   ...
   for MEMWAIT_Register use record
   ...
   for MOSCCR_Register use record
   ...
   for HOCOCR_Register use record
   ...
   for MOCOCR_Register use record
...
--  the system clock.
   ...
   for TRCKCR_Register use record
      TRCK     at 0 range 0 .. 3;
...
--  detection is notified to the POEG.
   ...
   for OSTDCR_Register use record
   ...
   for OSTDSR_Register use record
   ...
   type SLCDSCKCR_LCDSCKEN_Field is
     (--  LCD source clock out disabled
      ...
      Val_1)
     with Size => 1;
   for SLCDSCKCR_LCDSCKEN_Field use
     (Val_0 => 0,
      Val_1 => 1);
   ...
   for SLCDSCKCR_Register use record
...
--  mode.
   ...
   type SNZEDCR_AGTUNFED_Field is
     (--  Disable the Snooze End request
      ...
      Val_1)
     with Size => 1;
   for SNZEDCR_AGTUNFED_Field use
     (Val_0 => 0,
      Val_1 => 1);
   ...
   type SNZEDCR_DTCNZRED_Field is
     (--  Disable the Snooze End request
      ...
      Val_1)
     with Size => 1;
   for SNZEDCR_DTCNZRED_Field use
     (Val_0 => 0,
      Val_1 => 1);
   ...
   type SNZEDCR_AD0MATED_Field is
     (--  Disable the Snooze End request
      ...
      Val_1)
     with Size => 1;
   for SNZEDCR_AD0MATED_Field use
     (Val_0 => 0,
      Val_1 => 1);
   ...
   type SNZEDCR_AD0UMTED_Field is
     (--  Disable the Snooze End request
      ...
      Val_1)
     with Size => 1;
   for SNZEDCR_AD0UMTED_Field use
     (Val_0 => 0,
      Val_1 => 1);
   ...
   type SNZEDCR_SCI0UMTED_Field is
     (--  Disable the Snooze End request
      ...
      Val_1)
     with Size => 1;
   for SNZEDCR_SCI0UMTED_Field use
     (Val_0 => 0,
      Val_1 => 1);
   ...
   for SNZEDCR_Register use record
   ...
   type SNZREQCR_SNZREQEN0_Field is
     (--  Disable snooze request
      ...
      Val_1)
     with Size => 1;
   for SNZREQCR_SNZREQEN0_Field use
     (Val_0 => 0,
      Val_1 => 1);

   --  SNZREQCR_SNZREQEN array
   type SNZREQCR_SNZREQEN_Field_Array is array (0 .. 12)
     of SNZREQCR_SNZREQEN0_Field
     with Component_Size => 1, Size => 13;

   --  Type definition for SNZREQCR_SNZREQEN
   type SNZREQCR_SNZREQEN_Field
   ...
   for SNZREQCR_SNZREQEN_Field use record
      Val at 0 range 0 .. 12;
      Arr at 0 range 0 .. 12;
   end record;
   ...
   type SNZREQCR_SNZREQEN14_Field is
     (--  Disable snooze request
      ...
      Val_1)
     with Size => 1;
   for SNZREQCR_SNZREQEN14_Field use
     (Val_0 => 0,
      Val_1 => 1);

   --  SNZREQCR_SNZREQEN array
   type SNZREQCR_SNZREQEN_Field_Array_1 is array (14 .. 15)
     of SNZREQCR_SNZREQEN14_Field
     with Component_Size => 1, Size => 2;

   --  Type definition for SNZREQCR_SNZREQEN
   type SNZREQCR_SNZREQEN_Field_1
     (As_Array : Boolean := False)
   is record
      case As_Array is
         when False =>
   ...
   for SNZREQCR_SNZREQEN_Field_1 use record
      Val at 0 range 0 .. 1;
      Arr at 0 range 0 .. 1;
   end record;
   ...
   type SNZREQCR_SNZREQEN17_Field is
     (--  Disable snooze request
      ...
      Val_1)
     with Size => 1;
   for SNZREQCR_SNZREQEN17_Field use
     (Val_0 => 0,
      Val_1 => 1);

   subtype SNZREQCR_Reserved_Field is R7FA4M1AB.UInt5;
   ...
   type SNZREQCR_SNZREQEN23_Field is
     (--  Disable snooze request
      ...
      Val_1)
     with Size => 1;
   for SNZREQCR_SNZREQEN23_Field use
     (Val_0 => 0,
      Val_1 => 1);

   --  SNZREQCR_SNZREQEN array
   type SNZREQCR_SNZREQEN_Field_Array_2 is array (23 .. 25)
     of SNZREQCR_SNZREQEN23_Field
     with Component_Size => 1, Size => 3;

   --  Type definition for SNZREQCR_SNZREQEN
   type SNZREQCR_SNZREQEN_Field_2
     (As_Array : Boolean := False)
   is record
      case As_Array is
         when False =>
   ...
   for SNZREQCR_SNZREQEN_Field_2 use record
      Val at 0 range 0 .. 2;
      Arr at 0 range 0 .. 2;
   end record;

   subtype SNZREQCR_Reserved_Field_1 is R7FA4M1AB.UInt2;
   ...
   type SNZREQCR_SNZREQEN28_Field is
     (--  Disable snooze request
      ...
      Val_1)
     with Size => 1;
   for SNZREQCR_SNZREQEN28_Field use
     (Val_0 => 0,
      Val_1 => 1);

   --  SNZREQCR_SNZREQEN array
   type SNZREQCR_SNZREQEN_Field_Array_3 is array (28 .. 30)
     of SNZREQCR_SNZREQEN28_Field
     with Component_Size => 1, Size => 3;

   --  Type definition for SNZREQCR_SNZREQEN
   type SNZREQCR_SNZREQEN_Field_3
     (As_Array : Boolean := False)
   is record
      case As_Array is
         when False =>
   ...
   for SNZREQCR_SNZREQEN_Field_3 use record
      Val at 0 range 0 .. 2;
      Arr at 0 range 0 .. 2;
   end record;
   ...
   type SNZREQCR_Register is record
      ...
      --  These bits are read as 00000. The write value should be 00000.
      Reserved_2 : SNZREQCR_Reserved_Field := 16#0#;
      --  Snooze Request Enable 23 Enable RTC alarm snooze request
      SNZREQEN_2 : SNZREQCR_SNZREQEN_Field_2 :=
                    (As_Array => False, Val => 16#0#);
      --  These bits are read as 00. The write value should be 00.
      Reserved_3 : SNZREQCR_Reserved_Field_1 := 16#0#;
      --  Snooze Request Enable 28 Enable AGT1 underflow snooze request
   ...
   for SNZREQCR_Register use record
...
--  vice versa)
   ...
   for FLSTOP_Register use record
   ...
   for MOSCWTCR_Register use record
      MSTS     at 0 range 0 .. 3;
   ...
   for HOCOWTCR_Register use record
      HSTS     at 0 range 0 .. 2;
      Reserved at 0 range 3 .. 7;
   end record;
   ...
   for SOPCCR_Register use record
   ...
   for RSTSR1_Register use record
   ...
   for BKRACR_Register use record
   ...
   type USBCKCR_USBCLKSEL_Field is
     (--  PLL(Value after reset)
      ...
      Val_1)
     with Size => 1;
   for USBCKCR_USBCLKSEL_Field use
     (Val_0 => 0,
      Val_1 => 1);
   ...
   for USBCKCR_Register use record
   ...
   type PRCR_PRC3_Field is
     (--  Writes protected.
      ...
      Val_1)
     with Size => 1;
   for PRCR_PRC3_Field use
     (Val_0 => 0,
      Val_1 => 1);

   subtype PRCR_Reserved_Field is R7FA4M1AB.UInt4;
   ...
   type PRCR_Register is record
      ...
      --  These bits are read as 0000. The write value should be 0000.
      Reserved_1 : PRCR_Reserved_Field := 16#0#;
   ...
   for SYOCDCR_Register use record
   ...
   for RSTSR0_Register use record
      PORF     at 0 range 0 .. 0;
   ...
   for RSTSR2_Register use record
      CWSF     at 0 range 0 .. 0;
      Reserved at 0 range 1 .. 7;
   end record;
   ...
   type LVCMPCR_Reserved_Field_Array is array (1 .. 2)
     of LVCMPCR_Reserved_Element
     with Component_Size => 2, Size => 4;

   --  Type definition for LVCMPCR_Reserved
   type LVCMPCR_Reserved_Field
     (As_Array : Boolean := False)
   is record
      case As_Array is
         when False =>
   ...
   for LVCMPCR_Reserved_Field use record
      Val at 0 range 0 .. 3;
      Arr at 0 range 0 .. 3;
   end record;
   ...
   for LVCMPCR_Register use record
   ...
   for LVDLVLR_Register use record
   ...
   type LVDCR0_CMPE_Field is
     (--  Voltage Monitor circuit comparison result output disabled.
      ...
      Val_1)
     with Size => 1;
   for LVDCR0_CMPE_Field use
     (Val_0 => 0,
      Val_1 => 1);

   subtype LVDCR0_Reserved_Field is R7FA4M1AB.UInt3;
...
--  reset.
   ...
   type LVDCR0_Register is record
      ...
      --  These bits are read as 000. The write value should be 000.
      Reserved_1 : LVDCR0_Reserved_Field := 16#0#;
      --  Voltage Monitor Circuit Mode Select
   ...
   for LVDCR0_Register use record
      RIE        at 0 range 0 .. 0;
   ...
   for VBTCR1_Register use record
   ...
   for SOSCCR_Register use record
   ...
   for LOCOCR_Register use record
   ...
   for VBTCR2_Register use record
      Reserved   at 0 range 0 .. 3;
   ...
   type VBTCMPCR_VBTCMPE_Field is
     (--  VBATT pin low voltage detect circuit output disabled
      ...
      Val_1)
     with Size => 1;
   for VBTCMPCR_VBTCMPE_Field use
     (Val_0 => 0,
      Val_1 => 1);
   ...
   for VBTCMPCR_Register use record
   ...
   type VBTLVDICR_VBTLVDIE_Field is
     (--  VBATT Pin Low Voltage Detect Interrupt Disable
      ...
      Val_1)
     with Size => 1;
   for VBTLVDICR_VBTLVDIE_Field use
     (Val_0 => 0,
      Val_1 => 1);
   ...
   type VBTLVDICR_VBTLVDISEL_Field is
     (--  Non Maskable Interrupt
      ...
      Val_1)
     with Size => 1;
   for VBTLVDICR_VBTLVDISEL_Field use
     (Val_0 => 0,
      Val_1 => 1);
   ...
   for VBTLVDICR_Register use record
   ...
   for VBTWCTLR_Register use record
      VWEN     at 0 range 0 .. 0;
      Reserved at 0 range 1 .. 7;
   end record;
   ...
   type VBTWCH0OTSR_CH0VCH1TE_Field is
     (--  VBATT wakeup I/O 0 output trigger by the VBATWIO1 pin is disabled
      ...
      Val_1)
     with Size => 1;
   for VBTWCH0OTSR_CH0VCH1TE_Field use
     (Val_0 => 0,
      Val_1 => 1);
   ...
   type VBTWCH0OTSR_CH0VCH2TE_Field is
     (--  VBATT wakeup I/O 0 output trigger by the VBATWIO2 pin is disabled
      ...
      Val_1)
     with Size => 1;
   for VBTWCH0OTSR_CH0VCH2TE_Field use
     (Val_0 => 0,
      Val_1 => 1);
   ...
   type VBTWCH0OTSR_CH0VRTCTE_Field is
     (--  VBATT wakeup I/O 0 output trigger by the RTC periodic signal is disabled
      ...
      Val_1)
     with Size => 1;
   for VBTWCH0OTSR_CH0VRTCTE_Field use
     (Val_0 => 0,
      Val_1 => 1);
   ...
   type VBTWCH0OTSR_CH0VRTCATE_Field is
     (--  VBATT wakeup I/O 0 output trigger by the RTC alarm signal is disabled
      ...
      Val_1)
     with Size => 1;
   for VBTWCH0OTSR_CH0VRTCATE_Field use
     (Val_0 => 0,
      Val_1 => 1);

   subtype VBTWCH0OTSR_Reserved_Field is R7FA4M1AB.UInt3;
   ...
   type VBTWCH0OTSR_Register is record
      ...
      --  These bits are read as 000. The write value should be 000.
      Reserved_1 : VBTWCH0OTSR_Reserved_Field := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 8,
          Bit_Order => System.Low_Order_First;

   for VBTWCH0OTSR_Register use record
   ...
   type VBTWCH1OTSR_CH1VCH0TE_Field is
     (--  VBATT wakeup I/O 1 output trigger by the VBATWIO0 pin is disabled
      ...
      Val_1)
     with Size => 1;
   for VBTWCH1OTSR_CH1VCH0TE_Field use
     (Val_0 => 0,
      Val_1 => 1);
   ...
   type VBTWCH1OTSR_CH1VCH2TE_Field is
     (--  VBATT wakeup I/O 1 output trigger by the VBATWIO2 pin is disabled
      ...
      Val_1)
     with Size => 1;
   for VBTWCH1OTSR_CH1VCH2TE_Field use
     (Val_0 => 0,
      Val_1 => 1);
   ...
   type VBTWCH1OTSR_CH1VRTCTE_Field is
     (--  VBATT wakeup I/O 1 output trigger by the RTC periodic signal is disabled
      ...
      Val_1)
     with Size => 1;
   for VBTWCH1OTSR_CH1VRTCTE_Field use
     (Val_0 => 0,
      Val_1 => 1);
   ...
   type VBTWCH1OTSR_CH1VRTCATE_Field is
     (--  VBATT wakeup I/O 1 output trigger by the RTC alarm signal is disabled
      ...
      Val_1)
     with Size => 1;
   for VBTWCH1OTSR_CH1VRTCATE_Field use
     (Val_0 => 0,
      Val_1 => 1);

   subtype VBTWCH1OTSR_Reserved_Field is R7FA4M1AB.UInt3;
   ...
   type VBTWCH1OTSR_Register is record
      ...
      --  These bits are read as 000. The write value should be 000.
      Reserved_1 : VBTWCH1OTSR_Reserved_Field := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 8,
          Bit_Order => System.Low_Order_First;

   for VBTWCH1OTSR_Register use record
   ...
   type VBTWCH2OTSR_CH2VCH0TE_Field is
     (--  VBATT wakeup I/O 2 output trigger by the VBATWIO0 pin is disabled
      ...
      Val_1)
     with Size => 1;
   for VBTWCH2OTSR_CH2VCH0TE_Field use
     (Val_0 => 0,
      Val_1 => 1);
   ...
   type VBTWCH2OTSR_CH2VCH1TE_Field is
     (--  VBATT wakeup I/O 2 output trigger by the VBATWIO1 pin is disabled
      ...
      Val_1)
     with Size => 1;
   for VBTWCH2OTSR_CH2VCH1TE_Field use
     (Val_0 => 0,
      Val_1 => 1);
   ...
   type VBTWCH2OTSR_CH2VRTCTE_Field is
     (--  VBATT wakeup I/O 2 output trigger by the RTC periodic signal is disabled
      ...
      Val_1)
     with Size => 1;
   for VBTWCH2OTSR_CH2VRTCTE_Field use
     (Val_0 => 0,
      Val_1 => 1);
   ...
   type VBTWCH2OTSR_CH2VRTCATE_Field is
     (--  VBATT wakeup I/O 2 output trigger by the RTC alarm signal is disabled
      ...
      Val_1)
     with Size => 1;
   for VBTWCH2OTSR_CH2VRTCATE_Field use
     (Val_0 => 0,
      Val_1 => 1);

   subtype VBTWCH2OTSR_Reserved_Field is R7FA4M1AB.UInt3;
   ...
   type VBTWCH2OTSR_Register is record
      ...
      --  These bits are read as 000. The write value should be 000.
      Reserved_1 : VBTWCH2OTSR_Reserved_Field := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 8,
          Bit_Order => System.Low_Order_First;

   for VBTWCH2OTSR_Register use record
   ...
   type VBTICTLR_VCH0INEN_Field is
     (--  VBATWIO0, RTCIC0 inputs disabled
      ...
      Val_1)
     with Size => 1;
   for VBTICTLR_VCH0INEN_Field use
     (Val_0 => 0,
      Val_1 => 1);
   ...
   type VBTICTLR_VCH1INEN_Field is
     (--  VBATWIO1, RTCIC1 inputs disabled
      ...
      Val_1)
     with Size => 1;
   for VBTICTLR_VCH1INEN_Field use
     (Val_0 => 0,
      Val_1 => 1);
   ...
   type VBTICTLR_VCH2INEN_Field is
     (--  VBATWIO2 and RTCIC2 inputs disabled
      ...
      Val_1)
     with Size => 1;
   for VBTICTLR_VCH2INEN_Field use
     (Val_0 => 0,
      Val_1 => 1);
   ...
   for VBTICTLR_Register use record
   ...
   type VBTOCTLR_VCH0OEN_Field is
     (--  VBATWIO0 output disabled
      ...
      Val_1)
     with Size => 1;
   for VBTOCTLR_VCH0OEN_Field use
     (Val_0 => 0,
      Val_1 => 1);
   ...
   type VBTOCTLR_VCH1OEN_Field is
     (--  VBATWIO1 output disabled
      ...
      Val_1)
     with Size => 1;
   for VBTOCTLR_VCH1OEN_Field use
     (Val_0 => 0,
      Val_1 => 1);
   ...
   type VBTOCTLR_VCH2OEN_Field is
     (--  VBATWIO2 output disabled
      ...
      Val_1)
     with Size => 1;
   for VBTOCTLR_VCH2OEN_Field use
     (Val_0 => 0,
      Val_1 => 1);
   ...
   type VBTOCTLR_VOUT0LSEL_Field is
     (--  Output L before VBATT wakeup trigger
      ...
      Val_1)
     with Size => 1;
   for VBTOCTLR_VOUT0LSEL_Field use
     (Val_0 => 0,
      Val_1 => 1);
   ...
   type VBTOCTLR_VOUT1LSEL_Field is
     (--  Output L before VBATT wake up trigger
      ...
      Val_1)
     with Size => 1;
   for VBTOCTLR_VOUT1LSEL_Field use
     (Val_0 => 0,
      Val_1 => 1);
   ...
   type VBTOCTLR_VOUT2LSEL_Field is
     (--  Output L before VBATT wake up trigger
      ...
      Val_1)
     with Size => 1;
   for VBTOCTLR_VOUT2LSEL_Field use
     (Val_0 => 0,
      Val_1 => 1);
   ...
   for VBTOCTLR_Register use record
   ...
   for VBTWTER_Register use record
   ...
   for VBTWEGR_Register use record
   ...
   for VBTWFR_Register use record
