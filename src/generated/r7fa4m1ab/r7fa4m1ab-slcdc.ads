...
package R7FA4M1AB.SLCDC is
   ...
   type LCDM0_LWAVE_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for LCDM0_LWAVE_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type LCDM1_LCDVLM_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for LCDM1_LCDVLM_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type LCDM1_LCDSEL_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for LCDM1_LCDSEL_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type LCDM1_BLON_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for LCDM1_BLON_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type LCDM1_VLCON_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for LCDM1_VLCON_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type LCDM1_SCOC_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for LCDM1_SCOC_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type LCDM1_LCDON_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for LCDM1_LCDON_Field use (Val_0 => 0, Val_1 => 1);
