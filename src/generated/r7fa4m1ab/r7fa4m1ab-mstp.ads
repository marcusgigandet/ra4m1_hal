...
package R7FA4M1AB.MSTP is
   ...
   type MSTPCRB_MSTPB2_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for MSTPCRB_MSTPB2_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type MSTPCRB_MSTPB8_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for MSTPCRB_MSTPB8_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type MSTPCRB_MSTPB_Field (As_Array : Boolean := False) is record
      case As_Array is
         when False =>
            --  MSTPB as a value
            Val : R7FA4M1AB.UInt2;
   ...
   for MSTPCRB_MSTPB_Field use
     record
       Val at 0 range 0 .. 1;
       Arr at 0 range 0 .. 1;
     end record;

   subtype MSTPCRB_Reserved_Field_2 is R7FA4M1AB.Bit;
   ...
   type MSTPCRB_MSTPB11_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for MSTPCRB_MSTPB11_Field use (Val_0 => 0, Val_1 => 1);

   subtype MSTPCRB_Reserved_Field_3 is R7FA4M1AB.UInt6;
   ...
   type MSTPCRB_MSTPB18_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for MSTPCRB_MSTPB18_Field use (Val_0 => 0, Val_1 => 1);

   --  MSTPCRB_MSTPB array
   type MSTPCRB_MSTPB_Field_Array_1 is
     array (18 .. 19) of MSTPCRB_MSTPB18_Field
   with Component_Size => 1, Size => 2;

   --  Type definition for MSTPCRB_MSTPB
   type MSTPCRB_MSTPB_Field_1 (As_Array : Boolean := False) is record
      case As_Array is
         when False =>
            --  MSTPB as a value
            Val : R7FA4M1AB.UInt2;
   ...
   type MSTPCRB_MSTPB22_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for MSTPCRB_MSTPB22_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type MSTPCRB_MSTPB29_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for MSTPCRB_MSTPB29_Field use (Val_0 => 0, Val_1 => 1);

   --  MSTPCRB_MSTPB array
   type MSTPCRB_MSTPB_Field_Array_2 is
     array (29 .. 31) of MSTPCRB_MSTPB29_Field
   with Component_Size => 1, Size => 3;

   --  Type definition for MSTPCRB_MSTPB
   type MSTPCRB_MSTPB_Field_2 (As_Array : Boolean := False) is record
      case As_Array is
         when False =>
            --  MSTPB as a value
            Val : R7FA4M1AB.UInt3;
   ...
   type MSTPCRC_MSTPC0_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for MSTPCRC_MSTPC0_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type MSTPCRC_MSTPC_Field (As_Array : Boolean := False) is record
      case As_Array is
         when False =>
            --  MSTPC as a value
            Val : R7FA4M1AB.UInt2;
   ...
   for MSTPCRC_MSTPC_Field use
     record
       Val at 0 range 0 .. 1;
       Arr at 0 range 0 .. 1;
     end record;

   subtype MSTPCRC_Reserved_Field is R7FA4M1AB.Bit;
   ...
   type MSTPCRC_MSTPC3_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for MSTPCRC_MSTPC3_Field use (Val_0 => 0, Val_1 => 1);
   ...
   --  Type definition for MSTPCRC_MSTPC
   type MSTPCRC_MSTPC_Field_1 (As_Array : Boolean := False) is record
      case As_Array is
         when False =>
            --  MSTPC as a value
            Val : R7FA4M1AB.UInt2;
   ...
   for MSTPCRC_MSTPC_Field_1 use
     record
       Val at 0 range 0 .. 1;
       Arr at 0 range 0 .. 1;
     end record;

   subtype MSTPCRC_Reserved_Field_1 is R7FA4M1AB.UInt3;
   ...
   type MSTPCRC_MSTPC8_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for MSTPCRC_MSTPC8_Field use (Val_0 => 0, Val_1 => 1);

   subtype MSTPCRC_Reserved_Field_2 is R7FA4M1AB.UInt4;
   ...
   type MSTPCRC_MSTPC13_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for MSTPCRC_MSTPC13_Field use (Val_0 => 0, Val_1 => 1);

   --  MSTPCRC_MSTPC array
   type MSTPCRC_MSTPC_Field_Array_2 is
     array (13 .. 14) of MSTPCRC_MSTPC13_Field
   with Component_Size => 1, Size => 2;

   --  Type definition for MSTPCRC_MSTPC
   type MSTPCRC_MSTPC_Field_2 (As_Array : Boolean := False) is record
      case As_Array is
         when False =>
            --  MSTPC as a value
            Val : R7FA4M1AB.UInt2;
   ...
   for MSTPCRC_MSTPC_Field_2 use
     record
       Val at 0 range 0 .. 1;
       Arr at 0 range 0 .. 1;
     end record;

   subtype MSTPCRC_Reserved_Field_3 is R7FA4M1AB.UInt16;
   ...
   type MSTPCRC_MSTPC31_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for MSTPCRC_MSTPC31_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type MSTPCRD_MSTPD2_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for MSTPCRD_MSTPD2_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type MSTPCRD_MSTPD_Field (As_Array : Boolean := False) is record
      case As_Array is
         when False =>
            --  MSTPD as a value
            Val : R7FA4M1AB.UInt2;
   ...
   for MSTPCRD_MSTPD_Field use
     record
       Val at 0 range 0 .. 1;
       Arr at 0 range 0 .. 1;
     end record;

   subtype MSTPCRD_Reserved_Field_1 is R7FA4M1AB.Bit;
   ...
   type MSTPCRD_MSTPD5_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for MSTPCRD_MSTPD5_Field use (Val_0 => 0, Val_1 => 1);
   ...
   --  Type definition for MSTPCRD_MSTPD
   type MSTPCRD_MSTPD_Field_1 (As_Array : Boolean := False) is record
      case As_Array is
         when False =>
            --  MSTPD as a value
            Val : R7FA4M1AB.UInt2;
   ...
   for MSTPCRD_MSTPD_Field_1 use
     record
       Val at 0 range 0 .. 1;
       Arr at 0 range 0 .. 1;
     end record;

   subtype MSTPCRD_Reserved_Field_2 is R7FA4M1AB.UInt7;
   ...
   type MSTPCRD_MSTPD14_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for MSTPCRD_MSTPD14_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type MSTPCRD_MSTPD16_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for MSTPCRD_MSTPD16_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type MSTPCRD_MSTPD19_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for MSTPCRD_MSTPD19_Field use (Val_0 => 0, Val_1 => 1);

   --  MSTPCRD_MSTPD array
   type MSTPCRD_MSTPD_Field_Array_2 is
     array (19 .. 20) of MSTPCRD_MSTPD19_Field
   with Component_Size => 1, Size => 2;

   --  Type definition for MSTPCRD_MSTPD
   type MSTPCRD_MSTPD_Field_2 (As_Array : Boolean := False) is record
      case As_Array is
         when False =>
            --  MSTPD as a value
            Val : R7FA4M1AB.UInt2;
   ...
   for MSTPCRD_MSTPD_Field_2 use
     record
       Val at 0 range 0 .. 1;
       Arr at 0 range 0 .. 1;
     end record;

   subtype MSTPCRD_Reserved_Field_3 is R7FA4M1AB.Byte;
   ...
   type MSTPCRD_MSTPD29_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for MSTPCRD_MSTPD29_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type MSTPCRD_MSTPD31_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for MSTPCRD_MSTPD31_Field use (Val_0 => 0, Val_1 => 1);
