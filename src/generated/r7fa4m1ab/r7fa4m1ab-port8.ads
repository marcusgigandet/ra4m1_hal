...
package R7FA4M1AB.PORT8 is
   ...
   --  Port 8 Control Registers
   type PORT8_Peripheral (Discriminent : PORT8_Disc := View_PDR) is record
   ...
   --  Port 8 Control Registers
   PORT8_Periph : aliased PORT8_Peripheral
   with Import, Address => PORT8_Base;
