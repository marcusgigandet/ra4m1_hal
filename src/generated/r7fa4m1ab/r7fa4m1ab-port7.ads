...
package R7FA4M1AB.PORT7 is
   ...
   --  Port 7 Control Registers
   type PORT7_Peripheral (Discriminent : PORT7_Disc := View_PDR) is record
   ...
   --  Port 7 Control Registers
   PORT7_Periph : aliased PORT7_Peripheral
   with Import, Address => PORT7_Base;
