...
package R7FA4M1AB.POEG is
   ...
   type POEGG0_PIDF_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for POEGG0_PIDF_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type POEGG0_IOCF_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for POEGG0_IOCF_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type POEGG0_OSTPF_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for POEGG0_OSTPF_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type POEGG0_SSF_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for POEGG0_SSF_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type POEGG0_PIDE_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for POEGG0_PIDE_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type POEGG0_IOCE_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for POEGG0_IOCE_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type POEGG0_OSTPE_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for POEGG0_OSTPE_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type POEGG0_ST_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for POEGG0_ST_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type POEGG0_INV_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for POEGG0_INV_Field use (Val_0 => 0, Val_1 => 1);
   ...
   type POEGG0_NFEN_Field is
     ...
     Val_0,
      ...
      Val_1)
   with Size => 1;
   for POEGG0_NFEN_Field use (Val_0 => 0, Val_1 => 1);
