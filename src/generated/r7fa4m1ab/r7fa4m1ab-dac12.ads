...
--  enabled).
   ...
   for DAADSCR_Register use record
   ...
   for DAVREFCR_Register use record
      REF      at 0 range 0 .. 2;
   ...
   for DAC12_Peripheral use record
