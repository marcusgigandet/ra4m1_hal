...
package R7FA4M1AB.CAN0 is
   ...
   for MIER_FIFO_MB_Field use record
      Val at 0 range 0 .. 24;
      Arr at 0 range 0 .. 24;
   end record;
   ...
   for MIER_FIFO_Register use record
      MB             at 0 range 0 .. 24;
...
--  completed, or transmission abort is not requested
   ...
   type MCTL_RX_INVALDATA_Field is
     (--  Message valid
      ...
      Val_1)
     with Size => 1;
   for MCTL_RX_INVALDATA_Field use
     (Val_0 => 0,
      Val_1 => 1);
   ...
   for MCTL_RX_Register use record
...
--  FIFO.
   ...
   --  CAN0 Module
   type CAN0_Peripheral
     (Discriminent : CAN0_Disc := View_MB_ID0)
   is record
