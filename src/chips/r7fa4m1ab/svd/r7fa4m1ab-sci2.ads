...
--  length(SCMR.CHR1=1)
   ...
   type SMR_Register is record
      --  Clock Select
      CKS  : SMR_CKS_Field := R7FA4M1AB.SCI2.Val_00;
      --  Multi-Processor Mode (Valid only in asynchronous mode)
      MP   : SMR_MP_Field := R7FA4M1AB.SCI2.Val_0;
      --  Stop Bit Length (Valid only in asynchronous mode)
      STOP : SMR_STOP_Field := R7FA4M1AB.SCI2.Val_0;
      --  Parity Mode (Valid only when the PE bit is 1)
      PM   : SMR_PM_Field := R7FA4M1AB.SCI2.Val_0;
      --  Parity Enable (Valid only in asynchronous mode)
      PE   : SMR_PE_Field := R7FA4M1AB.SCI2.Val_0;
      --  Character Length (Valid only in asynchronous mode)
      CHR  : SMR_CHR_Field := R7FA4M1AB.SCI2.Val_0;
      --  Communication Mode
      CM   : SMR_CM_Field := R7FA4M1AB.SCI2.Val_0;
   end record
...
--  (SCMR.BCP2=1)
   ...
   type SMR_SMCI_Register is record
      --  Clock Select
      CKS : SMR_SMCI_CKS_Field := R7FA4M1AB.SCI2.Val_00;
      --  Base Clock Pulse (Valid only in asynchronous mode)
      BCP : SMR_SMCI_BCP_Field := R7FA4M1AB.SCI2.Val_00;
      --  Parity Mode (Valid only when the PE bit is 1)
      PM  : SMR_SMCI_PM_Field := R7FA4M1AB.SCI2.Val_0;
      --  Parity Enable (Valid only in asynchronous mode)
      PE  : SMR_SMCI_PE_Field := R7FA4M1AB.SCI2.Val_0;
      --  Block Transfer Mode
      BLK : SMR_SMCI_BLK_Field := R7FA4M1AB.SCI2.Val_0;
      --  GSM Mode
      GM  : SMR_SMCI_GM_Field := R7FA4M1AB.SCI2.Val_0;
   end record
     with Volatile_Full_Access, Object_Size => 8,
          Bit_Order => System.Low_Order_First;
...
--  resumed.
   ...
   type SCR_Register is record
      --  Clock Enable
      CKE  : SCR_CKE_Field := R7FA4M1AB.SCI2.Val_00;
      --  Transmit End Interrupt Enable
      TEIE : SCR_TEIE_Field := R7FA4M1AB.SCI2.Val_0;
      --  Multi-Processor Interrupt Enable (Valid in asynchronous mode when
      --  SMR.MP = 1)
      MPIE : SCR_MPIE_Field := R7FA4M1AB.SCI2.Val_0;
      --  Receive Enable
      RE   : SCR_RE_Field := R7FA4M1AB.SCI2.Val_0;
      --  Transmit Enable
      TE   : SCR_TE_Field := R7FA4M1AB.SCI2.Val_0;
      --  Receive Interrupt Enable
      RIE  : SCR_RIE_Field := R7FA4M1AB.SCI2.Val_0;
      --  Transmit Interrupt Enable
      TIE  : SCR_TIE_Field := R7FA4M1AB.SCI2.Val_0;
   end record
     with Volatile_Full_Access, Object_Size => 8,
          Bit_Order => System.Low_Order_First;
   ...
   type SCR_SMCI_Register is record
      --  Clock Enable
      CKE  : SCR_SMCI_CKE_Field := R7FA4M1AB.SCI2.Val_00;
      --  Transmit End Interrupt Enable
      TEIE : SCR_SMCI_TEIE_Field := 16#0#;
      --  Multi-Processor Interrupt Enable
      MPIE : SCR_SMCI_MPIE_Field := 16#0#;
      --  Receive Enable
      RE   : SCR_SMCI_RE_Field := R7FA4M1AB.SCI2.Val_0;
      --  Transmit Enable
      TE   : SCR_SMCI_TE_Field := R7FA4M1AB.SCI2.Val_0;
      --  Receive Interrupt Enable
      RIE  : SCR_SMCI_RIE_Field := R7FA4M1AB.SCI2.Val_0;
      --  Transmit Interrupt Enable
      TIE  : SCR_SMCI_TIE_Field := R7FA4M1AB.SCI2.Val_0;
   end record
     with Volatile_Full_Access, Object_Size => 8,
          Bit_Order => System.Low_Order_First;
   ...
   type SSR_Register is record
      --  Multi-Processor Bit Transfer
      MPBT : SSR_MPBT_Field := R7FA4M1AB.SCI2.Val_0;
      --  Read-only. Multi-Processor
      MPB  : SSR_MPB_Field := R7FA4M1AB.SCI2.Val_0;
      --  Read-only. Transmit End Flag
      TEND : SSR_TEND_Field := R7FA4M1AB.SCI2.Val_1;
      ...
      PER  : SSR_PER_Field := R7FA4M1AB.SCI2.Val_0;
      --  Write data bit of zero shall clear (set to zero) the corresponding
      --  bit in the field. *** This field is modified following a read
      --  operation ***. Framing Error Flag
      FER  : SSR_FER_Field := R7FA4M1AB.SCI2.Val_0;
      --  Write data bit of zero shall clear (set to zero) the corresponding
      --  bit in the field. *** This field is modified following a read
      --  operation ***. Overrun Error Flag
      ORER : SSR_ORER_Field := R7FA4M1AB.SCI2.Val_0;
      --  Write data bit of zero shall clear (set to zero) the corresponding
      --  bit in the field. *** This field is modified following a read
      --  operation ***. Receive Data Full Flag
      RDRF : SSR_RDRF_Field := R7FA4M1AB.SCI2.Val_0;
      --  Write data bit of zero shall clear (set to zero) the corresponding
      --  bit in the field. *** This field is modified following a read
      --  operation ***. Transmit Data Empty Flag
      TDRE : SSR_TDRE_Field := R7FA4M1AB.SCI2.Val_1;
   end record
     with Volatile_Full_Access, Object_Size => 8,
          Bit_Order => System.Low_Order_First;
   ...
   type SSR_SMCI_Register is record
      ...
      --  Read-only. Transmit End Flag
      TEND : SSR_SMCI_TEND_Field := R7FA4M1AB.SCI2.Val_1;
      --  Write data bit of zero shall clear (set to zero) the corresponding
      --  bit in the field. *** This field is modified following a read
      --  operation ***. Parity Error Flag
      PER  : SSR_SMCI_PER_Field := R7FA4M1AB.SCI2.Val_0;
      --  Write data bit of zero shall clear (set to zero) the corresponding
      --  bit in the field. *** This field is modified following a read
      --  operation ***. Error Signal Status Flag
      ERS  : SSR_SMCI_ERS_Field := R7FA4M1AB.SCI2.Val_0;
      --  Write data bit of zero shall clear (set to zero) the corresponding
      --  bit in the field. *** This field is modified following a read
      --  operation ***. Overrun Error Flag
      ORER : SSR_SMCI_ORER_Field := R7FA4M1AB.SCI2.Val_0;
      --  Write data bit of zero shall clear (set to zero) the corresponding
      --  bit in the field. *** This field is modified following a read
      --  operation ***. Receive Data Full Flag
      RDRF : SSR_SMCI_RDRF_Field := R7FA4M1AB.SCI2.Val_0;
      --  Write data bit of zero shall clear (set to zero) the corresponding
      --  bit in the field. *** This field is modified following a read
      --  operation ***. Transmit Data Empty Flag
      TDRE : SSR_SMCI_TDRE_Field := R7FA4M1AB.SCI2.Val_1;
   end record
     with Volatile_Full_Access, Object_Size => 8,
          Bit_Order => System.Low_Order_First;
...
--  256(SMR.BCP[1:0]=11)
   ...
   type SCMR_Register is record
      --  Smart Card Interface Mode Select
      SMIF       : SCMR_SMIF_Field := R7FA4M1AB.SCI2.Val_0;
      ...
      SINV       : SCMR_SINV_Field := R7FA4M1AB.SCI2.Val_0;
      --  Transmitted/Received Data Transfer Direction NOTE: The setting is
      --  invalid and a fixed data length of 8 bits is used in modes other than
      --  asynchronous mode. Set this bit to 1 if operation is to be in simple
      --  I2C mode.
      SDIR       : SCMR_SDIR_Field := R7FA4M1AB.SCI2.Val_0;
      --  Character Length 1 (Only valid in asynchronous mode)
      CHR1       : SCMR_CHR1_Field := R7FA4M1AB.SCI2.Val_1;
      --  These bits are read as 11. The write value should be 11.
      Reserved_1 : SCMR_Reserved_Field_1 := 16#3#;
      --  Base Clock Pulse 2 Selects the number of base clock cycles in
      --  combination with the SMR.BCP[1:0] bits
      BCP2       : SCMR_BCP2_Field := R7FA4M1AB.SCI2.Val_1;
   end record
     with Volatile_Full_Access, Object_Size => 8,
          Bit_Order => System.Low_Order_First;
...
--  enabled.
   ...
   type SEMR_Register is record
      ...
      --  Bit Rate Modulation Enable
      BRME     : SEMR_BRME_Field := R7FA4M1AB.SCI2.Val_0;
      --  Asynchronous Mode Extended Base Clock Select 1 (Valid only in
      --  asynchronous mode and SCR.CKE[1]=0)
      ABCSE    : SEMR_ABCSE_Field := R7FA4M1AB.SCI2.Val_0;
      --  Asynchronous Mode Base Clock Select (Valid only in asynchronous mode)
      ABCS     : SEMR_ABCS_Field := R7FA4M1AB.SCI2.Val_0;
...
--  mode)
   ...
   type SNFR_Register is record
      --  Noise Filter Clock Select
      NFCS     : SNFR_NFCS_Field := R7FA4M1AB.SCI2.Val_000;
...
--  on-chip baud rate generator.
   ...
   type SIMR1_Register is record
      --  Simple I2C Mode Select
      IICM     : SIMR1_IICM_Field := R7FA4M1AB.SCI2.Val_0;
      --  These bits are read as 00. The write value should be 00.
      Reserved : SIMR1_Reserved_Field := 16#0#;
      --  SDA Delay Output Select Cycles below are of the clock signal from the
      --  on-chip baud rate generator.
      IICDL    : SIMR1_IICDL_Field := R7FA4M1AB.SCI2.Val_00000;
   end record
     with Volatile_Full_Access, Object_Size => 8,
          Bit_Order => System.Low_Order_First;
   ...
   type SIMR2_Register is record
      --  I2C Interrupt Mode Select
      IICINTM    : SIMR2_IICINTM_Field := R7FA4M1AB.SCI2.Val_0;
      --  Clock Synchronization
      IICCSC     : SIMR2_IICCSC_Field := R7FA4M1AB.SCI2.Val_0;
      --  These bits are read as 000. The write value should be 000.
      Reserved   : SIMR2_Reserved_Field := 16#0#;
      --  ACK Transmission Data
      IICACKT    : SIMR2_IICACKT_Field := R7FA4M1AB.SCI2.Val_0;
      --  These bits are read as 00. The write value should be 00.
...
--  generated.
   ...
   type SIMR3_Register is record
      --  Start Condition Generation
      IICSTAREQ  : SIMR3_IICSTAREQ_Field := R7FA4M1AB.SCI2.Val_0;
      --  Restart Condition Generation
      IICRSTAREQ : SIMR3_IICRSTAREQ_Field := R7FA4M1AB.SCI2.Val_0;
      --  Stop Condition Generation
      IICSTPREQ  : SIMR3_IICSTPREQ_Field := R7FA4M1AB.SCI2.Val_0;
      --  Write data bit of zero shall clear (set to zero) the corresponding
      --  bit in the field. *** This field is modified following a read
      --  operation ***. Issuing of Start, Restart, or Stop Condition Completed
      --  Flag (When 0 is written to IICSTIF, it is cleared to 0.)
      IICSTIF    : SIMR3_IICSTIF_Field := R7FA4M1AB.SCI2.Val_0;
      --  SDA Output Select
      IICSDAS    : SIMR3_IICSDAS_Field := R7FA4M1AB.SCI2.Val_00;
      --  SCL Output Select
      IICSCLS    : SIMR3_IICSCLS_Field := R7FA4M1AB.SCI2.Val_00;
   end record
     with Volatile_Full_Access, Object_Size => 8,
          Bit_Order => System.Low_Order_First;
...
--  (slave mode).
   ...
   type SPMR_Register is record
      --  SSn Pin Function Enable
      SSE        : SPMR_SSE_Field := R7FA4M1AB.SCI2.Val_0;
      --  CTS Enable
      CTSE       : SPMR_CTSE_Field := R7FA4M1AB.SCI2.Val_0;
      --  Master Slave Select
      MSS        : SPMR_MSS_Field := R7FA4M1AB.SCI2.Val_0;
      --  This bit is read as 0. The write value should be 0.
      Reserved   : SPMR_Reserved_Field := 16#0#;
      --  Write data bit of zero shall clear (set to zero) the corresponding
      --  bit in the field. *** This field is modified following a read
      --  operation ***. Mode Fault Flag
      MFF        : SPMR_MFF_Field := R7FA4M1AB.SCI2.Val_0;
      --  This bit is read as 0. The write value should be 0.
      Reserved_1 : SPMR_Reserved_Field := 16#0#;
      --  Clock Polarity Select
      CKPOL      : SPMR_CKPOL_Field := R7FA4M1AB.SCI2.Val_0;
      --  Clock Phase Select
      CKPH       : SPMR_CKPH_Field := R7FA4M1AB.SCI2.Val_0;
   end record
     with Volatile_Full_Access, Object_Size => 8,
          Bit_Order => System.Low_Order_First;
   ...
   type DCCR_Register is record
      ...
      DCMF       : DCCR_DCMF_Field := R7FA4M1AB.SCI2.Val_0;
      --  These bits are read as 00. The write value should be 00.
      Reserved   : DCCR_Reserved_Field := 16#0#;
      --  Write data bit of zero shall clear (set to zero) the corresponding
      --  bit in the field. *** This field is modified following a read
      --  operation ***. Data Compare Match Parity Error Flag
      DPER       : DCCR_DPER_Field := R7FA4M1AB.SCI2.Val_0;
      --  Write data bit of zero shall clear (set to zero) the corresponding
      --  bit in the field. *** This field is modified following a read
      --  operation ***. Data Compare Match Framing Error Flag
      DFER       : DCCR_DFER_Field := R7FA4M1AB.SCI2.Val_0;
      --  This bit is read as 0. The write value should be 0.
      Reserved_1 : DCCR_Reserved_Field_1 := 16#0#;
      --  ID frame select (Valid only in asynchronous mode(including
      --  multi-processor)
      IDSEL      : DCCR_IDSEL_Field := R7FA4M1AB.SCI2.Val_1;
      --  Data Compare Match Enable (Valid only in asynchronous mode(including
      --  multi-processor)
      DCME       : DCCR_DCME_Field := R7FA4M1AB.SCI2.Val_0;
   end record
     with Volatile_Full_Access, Object_Size => 8,
          Bit_Order => System.Low_Order_First;
   ...
   --  Serial Communication Interface 2
   type SCI2_Peripheral
     (Discriminent : SCI2_Disc := View_BRR)
   is record
   ...
   for SCI2_Peripheral use record
   ...
   --  Serial Communication Interface 2
   SCI2_Periph : aliased SCI2_Peripheral
     with Import, Address => SCI2_Base;
