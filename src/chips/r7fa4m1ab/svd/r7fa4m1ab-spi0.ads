...
package R7FA4M1AB.SPI0 is
   ...
   type SPDCR_Reserved_Field_Array is array (1 .. 2)
     of SPDCR_Reserved_Element
     with Component_Size => 2, Size => 4;

   --  Type definition for SPDCR_Reserved
   type SPDCR_Reserved_Field
   ...
   for SPDCR_Reserved_Field use record
      Val at 0 range 0 .. 3;
      Arr at 0 range 0 .. 3;
   end record;
...
--  (SPCKD)
   ...
   type SPI0_Peripheral
     (Discriminent : SPI0_Disc := View_SPCR)
   is record
