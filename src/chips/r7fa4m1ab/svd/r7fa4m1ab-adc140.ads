...
--  accuracy.
   ...
   type ADCER_Reserved_Field_Array is array (1 .. 2)
     of ADCER_Reserved_Element
     with Component_Size => 1, Size => 2;

   --  Type definition for ADCER_Reserved
   type ADCER_Reserved_Field_1
   ...
   for ADCER_Reserved_Field_1 use record
      Val at 0 range 0 .. 1;
      Arr at 0 range 0 .. 1;
   end record;
...
--  continuous scan mode, or group scan mode.
   ...
   type ADEXICR_Reserved_Field_Array is array (1 .. 3)
     of ADEXICR_Reserved_Element
   ...
   --  ADEXICR_Reserved array
   type ADEXICR_Reserved_Field_Array_1 is array (1 .. 2)
     of ADEXICR_Reserved_Element
     with Component_Size => 1, Size => 2;
